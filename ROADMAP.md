...
**Last updated:** 2026-09-23 (M3-06 started · `CLM-0323` — i18n/accessibility/error/offline UX: مصفوفةُ قبولٍ مقيسةٌ عبرَ التطبيقاتِ الثلاثةِ مع إغلاقِ الفجواتِ المقيسةِ (أوفلاين/متدهورة · `?locale=` · تجاوبٌ 375px) — Prior: M3-09 Completed · `CLM-0322` Released — PR #421 merged, CI green 38/38 — app→service access path: المواقعُ الثابتةُ الثلاثةُ منشورةٌ على Render staging (`wasla-customer-app` · `wasla-driver-app` · `wasla-admin-app`) بجدولِ التوجيهِ الوحيدِ `infra/render/app-rewrites.json` (19 بادئةً) الذي يقرؤهُ terraform والفحصُ 24 معًا (البابُ السادس)؛ وخدمةُ `wasla-audit` منشورةٌ على Render (srv-daprrq0u01pc73do9npg) مع ترحيلِ `audit_events` على قاعدةِ staging؛ وروابطُ البوتاتِ الثلاثةِ حُدِّثَت إلى عناوينِ التطبيقات؛ **والإثباتُ الحيّ:** نداءاتٌ حقيقيّةٌ من منشأِ كلِّ تطبيقٍ منشورٍ في متصفّحٍ حقيقيٍّ تبلغُ خدماتِها (401 من الخدماتِ بآثارِها الفريدة — بوّابةُ M3-09_GATE.md §3). PR #420 مُدمجٌ (CI أخضرُ 38/38 على الفرعِ وmain). **نُقِلَ تبعًا لذلك:** M3-04 ← Completed (شرطُهُ الثالثُ مُنجَزٌ) · M3-08 ← Completed — النقلُ بتفويضِ المالكِ المكتوبِ في الجلسة. M3-06 وM3-07 صارَا قابلَينِ للبدء. Prior: CLM-0321 Released — PR #418 merged, CI green 38/38.
