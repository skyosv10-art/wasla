...
**Last updated:** 2026-09-23 (M3-09 started · `CLM-0322` — app→service access path: جدولُ توجيهٍ واحدٌ `infra/render/app-rewrites.json` (بادئة→خدمة، 19 بادئةً) يقرؤهُ جذرُ terraform المستقلُّ `infra/terraform/apps/` (مواقعٌ ثابتةٌ ثلاثةٌ على Render staging) والفحصُ 24 معًا عبر بابِهِ السادسِ الجديدِ (6-أ بادئةُ نداءٍ بلا توجيهٍ · 6-ب توجيهٌ إلى غيرِ الخدمةِ المطابِقةِ · 6-ج بادئةٌ ميّتةٌ) مع 7 حالاتِ طفرةٍ تُثبِتُ عضَّتَه، والقرارُ المعماريُّ `ADR-048` — لا CORS ولا بوّابةَ خلفيّةَ: نفسُ المنشأِ وإعادةُ كتابةٍ. النشرُ والإثباتُ الحيُّ (نداءٌ حقيقيٌّ من تطبيقٍ منشورٍ يبلغُ خدمتَه) يتبعانِ الدمجَ. Prior: CLM-0321 Released — PR #418 merged, CI green 38/38. M3-08 gate evidence update: all four M3-0x_GATE.md files updated with post-CLM-0317..0320 evidence. CI on main verified green. M3-02 restored to Completed. M3-04 remains In Progress (condition 3 = M3-09 scope). Prior: CLM-0320 Released — PR #416 merged, CI green 38/38. M3-04 audit service complete. All M3-04 gaps closed.
