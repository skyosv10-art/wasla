...
**Last updated:** 2026-09-23 (CLM-0320 — M3-04 audit service: created services/audit/ with POST /audit/events (append-only) and GET /audit/events (list with filters). 16 HTTP tests. All M3-04 gaps closed — APP_API_ROUTES gap count 1→0. Prior: CLM-0319 Released — PR #414 merged, CI green 38/38. Prior: CLM-0318 — M3-04 drivers list route. Prior: CLM-0317 — M3-04 orders prefix fix.
