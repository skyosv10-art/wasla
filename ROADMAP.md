...
**Last updated:** 2026-09-24 (M3-07 key rotation completed on live deploy · `CLM-0326` — الحالاتُ الثلاثُ k5→k6 على wasla-audit بثلاثِ نشراتٍ حيّةٍ ونداءاتٍ حقيقيّة (s3: `revoked_key`)؛ تصحيحٌ بالإضافة: الفشلُ الأوّلُ معرِّفٌ مكرَّرٌ لا توقيتُ Render، و`PUT /env-vars` لا يُعيد النشر؛ الفحصُ 25 يحرسُ أسماءَ أسبابِ الدليلِ (unknown_key). Prior: M3-07 partial · `CLM-0325` — PR #429 merged.
