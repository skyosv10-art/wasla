...
**Last updated:** 2026-09-24 (M3-07 started · `CLM-0325` — runbook drill على بيئةِ staging الحقيقيّةِ: مسحُ صحةِ الخدمات · إلحاقُ/قراءةُ أحداثِ التدقيق عبرَ الواجهة · تنفيذُ دليلِ تدويرِ المفاتيحِ بحالاتِهِ الثلاث · مصفوفةُ الإجراءاتِ التشغيليةِ — آخرُ بنودِ M3. Prior: M3-06 corrective hardening closed · `CLM-0324` Released — PR #426/#427 merged.
