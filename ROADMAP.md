...
**Last updated:** 2026-09-23 (CLM-0312 — M3-05 audit + enforcement: bot commands outside BOT_ROLE_SPEC §2 now fail at boot (`BOT_ALLOWED_COMMANDS` + spec⇔code test + real-composition-root tests + 4 mutations). PR #405 not merged — the exit gate was not yet enforced. M3-05 stays In Progress until CI verdict.) Earlier — CLM-0311 — M3-05 started: BOT_ROLE_SPEC.md created defining allowed commands per bot, abuse scenarios, user journeys. Journey and abuse tests to follow.) Earlier — CLM-0310: M3-04 Wave 4: UAT + Exit Gate complete. M3-04 COMPLETE. PR #402 merged (CI 36/36 green). Earlier — CLM-0308: M3-04 Wave 3 Orders + Audit Log UI. CLM-0305: M3-04 Wave 1 Admin portal scaffold. ADMIN_MVP_SPEC.md defines 5 screens, 2 RBAC roles, audit service, 4-wave breakdown. M3-01 Completed, M3-03 Completed via ADR-046. CLM-0303: ADR-046 defers Partner Mini App — bot-first partner surface, revisit when adoption demands. M3-01 Customer Mini App exit gate met. CLM-0300 released — PR #391 merged, squash `3cf4031`. M3-02 Wave 6 E2E + Accessibility. CLM-0298 released — PR #389 merged. M3-02 Wave 5 Job History/Earnings. CLM-0295 released — PR #387 merged. M3-02 Wave 4 Documents + Profile. CLM-0294 released — PR #385 merged. M3-02 Wave 3 Vehicles + Zones. CLM-0293 released — PR #383 merged. M3-02 Wave 2 Offer Feed + Job Detail. CLM-0292 released — PR #381 merged. M3-02 Wave 1 scaffold. CLM-0298 released — PR #389 merged. M3-02 Wave 5 Job History/Earnings. CLM-0295 released — PR #387 merged. M3-02 Wave 4 Documents + Profile. CLM-0294 released — PR #385 merged. M3-02 Wave 3 Vehicles + Zones. CLM-0293 released — PR #383 merged. M3-02 Wave 2 Offer Feed + Job Detail. CLM-0292 released — PR #381 merged. M3-02 Wave 1 scaffold. CLM-0291 released — PR #379 merged, squash `1ba229a`. M3-02 Driver Mini App product spec + ADR-045. CLM-0290 released — PR #377 merged, squash `0eb0a19`; CLM-0289 released — PR #376 merged, squash `c35feab`; CI green 36/36. M3-01 exit gate met. Earlier — CLM-0288 released — PR #374 merged, squash `16fd15c`; CI green 35/35. M3-01 Wave 5: my orders + reputation + profile screens, 14 new tests. Earlier — CLM-0287 released — PR #372 merged, squash `7c1d6c4`; CI green 35/35. M3-01 Wave 4: marketplace browse + search. Earlier — CLM-0286 released — PR #370 merged, squash `7cd781d`; CI green 35/35. M3-01 Wave 3: delivery order + saved places. Earlier — CLM-0285 released — PR #368 merged, squash `03066f7`; CI green 35/35. M3-01 Wave 2: ride order form. Earlier — CLM-0284 released — PR #366 merged, squash `52bf3d0`; CI green 35/35. M3-01 Wave 1 scaffold. Earlier — CLM-0283 released — PR #364 merged, squash `8045af6`; CI green. M3-01 product spec + ADR-044. Earlier — CLM-0282 released — PR #362 merged, squash `a1272b4`; CI green. M2-07 gate stale text corrected. Earlier — CLM-0281 released — PR #360 merged, squash `c3ffe46`; CI green. Delivery relay full DLQ lifecycle E2E proof added. Gate item 9 now ⚠️ only for G8. `relay-concurrent-dedupe.integration.test.ts` (3 integration tests on PostgreSQL). Closes declared debt in `M2-07_CRASH_RETRY_DEDUPE_PROOF.md` §3. Gate item 9 remains ⚠️ for G8 and delivery E2E proof. M2-07 stays In Progress. Earlier — CLM-0256 released — PR #313 merged, squash `7541a35`; CI read BOUND TO ITS MEASURE: 34/34 check-runs green on head 74e6a00 = 33 "WASLA CI" jobs + 1 "Roadmap freshness" job, while the PR statusCheckRollup total of 35 additionally includes a `Devin Review` StatusContext, an external app, not a gate this repo owns. Earlier — M2-07 gate truth resync (CLM-0256) — the defect was in the DOCUMENT, not the code: `docs/12-testing/M2-07_GATE.md` had drifted out of agreement with its own governing ledger (the inventory) across three merged batches. Item 11 still read `⚠️ partial, 8 of 10` after G3 was closed IN FULL by ADR-043/CLM-0253; G6 (CLM-0252) and G7 (CLM-0254) were not mentioned in the gate AT ALL; and §5 still declared "the next executable item is closing G1" when G1 had been closed by CLM-0241/0242/0243. A MEASUREMENT-ATTRIBUTION defect was also corrected: the figure "35/35 CI green" — written in this gate, in many WORK_CLAIMS.md rows, and in agent reports — was attributed each time to the "WASLA CI" run, which measures 33 jobs, not 35 (`gh api .../jobs --jq '[.jobs[].conclusion] | group_by(.) | map({(.[0]): length}) | add'` returns `{"success":33}` for ALL THREE referenced runs: b3a6bc3 / 674e743 / b938291). AND THIS CORRECTION CORRECTED ITSELF BEFORE MERGING: its first draft claimed 35 "was never measured", and measurement refuted that claim — the PR rollup genuinely returns `{"SUCCESS":35}`, because 35 is a real count of a DIFFERENT measure: 33 WASLA CI jobs + 1 "Roadmap freshness" job (a SEPARATE workflow run, not a job inside WASLA CI) + 1 `Devin Review` StatusContext, which is an external app's review status and not a gate this repository owns. So "35/35" is right about the PR and wrong about the run; "33/33" is right about the run; and one of the 35 is not our guard at all. The refutation of the first draft is recorded in gate §7.5 rather than quietly removed, because hiding a correction's own error destroys the correction's value. Counts in this gate are now written bound to their measure (`WASLA CI: 33/33`) instead of bare. The correction is by ADDITION, not erasure: the old text stays struck through in §1, §2 item 10 and §4, and a new §7 records the defect, the re-measurement table and the exact command to reproduce it. Released work-claim rows carrying "35/35" were deliberately NOT rewritten retroactively — they are a historical record of what was written at the time. Final gap measurement: G1–G7 CLOSED, G8 alone open and pre-declared `Expected` (no tick scheduler in code; a tick scheduler is a deployment concern in M2-02/M2-09 scope). This changes NO verdict: the gate stays NOT PASSED, item 7 stays blocked on RENDER_API_KEY/RENDER_OWNER_ID, M2-07 stays In Progress, and promoting it is the program owner's authority alone (§9). Earlier — M2-07 G7 closed (CLM-0254) — channel outbox drain adapter created: `ChannelOutboxDrainStore` implements `OutboxDrainStore` from `@wasla/outbox` for `channel_outbox` in `packages/channel-postgres`. `PostgresChannelOutboxDrainRunner` wraps Drizzle transaction. claim/markPublished/SKIP LOCKED. 5 integration tests on PostgreSQL. Only G8 (Expected) remains. Earlier — M2-07 G3 closed by ADR-043 (CLM-0253) — remaining 2 of 10 outbox tables (dispatch_outbox, marketplace_outbox) are relay-consumed with no producer-side drain. Retry state lives in consumer relay ledgers (delivery_relay_consumed_events, search_relay_consumed_events, delivery_inventory_relay_consumed_events), each with attempt_count, last_error, and poisoned status. Producer columns would have no writer and would duplicate consumer truth. G3 is CLOSED by design. 10 of 10 outbox tables now have durable retry/error state; earlier — M2-07 G6 (CLM-0252) — idempotency response storage added to 3 tables: `dispatch_idempotency` (migration 0002), `driver_idempotency` (migration 0004), `matching_idempotency` (migration 0003). Nullable `response_status INTEGER` + `response_body JSONB` columns with CHECK constraint (both null or both present) for backfill safety. `IdempotencyStore` port updated: `find()` returns `IdempotencyRecord` with `payloadFingerprint` + nullable `recordedResponse`; `remember()` now stores the response. `classifyIdempotency`/`classifyReplay` return `{ kind: "replay", response }` on cache hit, `{ kind: "legacy-replay" }` for pre-G6 rows. Legacy rows fall back to reprocessing. 8 of 8 idempotency tables now store the response. G6 is CLOSED; earlier — M2-07 G4 (CLM-0250) — trace_id column added to 6 outbox tables that lacked it: customer_outbox, driver_outbox, geo_outbox, identity_outbox, marketplace_outbox, search_outbox. 13/13 outbox tables now carry trace_id. Each table gets a reversible migration (`0003_outbox_trace_id` for customers/drivers/geography/identity, `0002_outbox_trace_id` for marketplace, `0004_outbox_trace_id` for search), all marked `@wasla-upgrade-proof: all-non-baseline`. Drain adapters in all 5 services now SELECT trace_id and return it via OutboxRecord.traceId. The search relay path propagates trace_id from marketplace_outbox through the event source to the relay log. 10 integration tests (2 per service: trace_id read + null case) and 1 relay unit test added. Journal entries added for all 6 services. G4 is CLOSED; earlier — M2-07 G5 wave 3 (CLM-0249) — the record: a poisoned search-relay row can now be dispositioned without being hidden. Waves 1 and 2 gave an eye and a hand, and left one state unanswered — a row whose cause still stands: requeueing it re-poisons it, leaving it keeps `warning` alight forever, and the only remaining operator move was to silence the signal, after which the NEXT loss is invisible too. That is how a measurement becomes worse than no measurement. `POST /search/relay/dead-letters/{ledger}/{outbox_id}/acknowledgement` (third independent scope `search:relay-dead-letters:acknowledge`) therefore adds a witness instead of removing a row: an all-or-none triple `acknowledged_at`/`acknowledged_by`/`acknowledgement_reason` written in reversible migration `0003_relay_acknowledgement` with four CHECKs (acknowledger 1..128, reason 12..512, all-or-none, acknowledged-only-if-poisoned) and a partial index for the unacknowledged read. The row keeps `status = 'poisoned'` — no sixth status, because a new status would drop the row out of every query that counts poisoned rows, which is exactly the hiding this wave exists to prevent. Instead the metric is SPLIT: `total_poisoned` stays reality and the verdict is issued on `total_unacknowledged_poisoned` alone, so an acknowledgement removes the row from the bell, never from the record. `already_acknowledged` answers `200` carrying the FIRST record rather than `409`: the caller did not err, the state they wanted holds, and they see who preceded them instead of assuming the disposition is theirs. Requeue (wave 2) now CLEARS the triple in the same statement, and the database enforces it via `ck_…_ack_poisoned_only` rather than trusting code convention — without that constraint a requeued row could carry "handled" into a live state, be re-poisoned later, and read as already-dispositioned, invisible in the verdict forever; the integration test proves the refusal with a direct `UPDATE` that bypasses the adapter (`23514`). Proven by 14 unit and 7 real-PostgreSQL cases; search unit suite 134 (120 baseline + 14); authz-policy 42/42; the service-auth-coverage, app-port-wiring and baseline guards green after their published numbers were moved to the new measurement (135 operations, 14 wired ports, 405 test files) rather than the guards being loosened. Limits published rather than hidden: an acknowledgement never expires (no `snooze` was implemented and its absence is written rather than left to be assumed), it fixes nothing by itself, no notification leaves the service because there is no notifier in this boundary at all, `gates_readiness: false`, and the age stays measured from `consumed_at` because the search ledger has no `updated_at` and adding one for this wave alone would have created a second source of truth for a timestamp nobody reads. The 7 pre-existing integration timeouts reproduce identically on unmodified `main` against the remote pooler and no timeout or budget was raised; the partial-triple case was fixed by issuing its four independent failing `UPDATE`s with `Promise.allSettled` instead of sequentially. G5 is now CLOSED as written — eye, hand and record — and nothing more is claimed: no tick scheduler runs any of the three on a timer, which is the pre-declared `G8` gap, so the whole lifecycle remains operator-driven; M2-02 stays blocked and M2-07 stays In Progress with its gate NOT PASSED; earlier the same day — M2-07 G5 wave 2 (CLM-0248) — the hand: a poisoned search-relay row can now be put back in the queue. `POST /search/relay/dead-letters/{ledger}/{outbox_id}/requeue` (scope `search:relay-dead-letters:requeue`, separate from the read scope) does TWO things in ONE transaction, because either one alone is a defect: it lifts the row out of finality (`poisoned` → `pending`, `FOR UPDATE`) AND rewinds the relay checkpoint. Measured before writing a line, not assumed: `isTerminal(status)` in `services/search/src/relay.ts` is `status !== "pending"` and a terminal row short-circuits step 1, so rewinding alone re-reads the row and re-reports `poisoned`; and the checkpoint was deliberately advanced past the row when it was poisoned, so lifting alone leaves a `pending` row that is never read AND drops out of wave 1's measurement — a loss more hidden than before. The rewind is `DELETE FROM search_relay_checkpoint`, not a written zero sentinel, because `getCheckpoint` returns null and `readAfter(null)` already reads from the beginning — one source of truth instead of a second copy of the sentinel. `attempt_count`, `last_error` and `consumed_at` are deliberately NOT reset and the body says so in `evidence_preserved`: they are the only record of why the row was poisoned, and refreshing `consumed_at` would zero the age of a still-unresolved loss and lift a week-old broken row out of wave 1's critical-age threshold without fixing anything. Answers `202` with `outcome: "requeued"`, never `"reprocessed"` — a caller who reads "fixed" closes an incident that was not fixed; `404` for an unknown row (no silent success), `409` for a row that is not `poisoned` (which also makes the action naturally idempotent, so there is no idempotency key), `400` for an unknown ledger or a malformed uuid rejected before the database is touched (a `22P02` would surface as a false `503` verdict on the service), `503` when no port is composed. Limits published rather than hidden: no advisory lock (the search relay owns none, and a lock on an invented key the other side never takes is decorative), the rewind is to zero with its cost published as `rewind_cost: "full_rescan_from_zero"`, and `gates_readiness: false`. Proven by 10 unit and 6 real-PostgreSQL integration cases: both moves happen together, the evidence columns are untouched to the character, a rejected call writes nothing (ledger fingerprint and checkpoint identical before and after), and the requeued row drops out of wave 1's own metric. Baseline note: 7 pre-existing integration timeouts in `services/search` reproduce identically on unmodified `main` against the remote Supabase pooler (5000ms default vs pooler RTT) — environmental, verified in a separate worktree of `main` before any change was attributed, and no timeout or budget was raised to hide it; CI runs local PostgreSQL. G5 remains PARTIALLY closed: acknowledgement (wave 3) is still missing and needs a migration adding `acknowledged_at`/`acknowledged_by`/`acknowledgement_reason` with an all-or-none CHECK; earlier the same day — M2-07 G5 wave 1 (CLM-0247) — the first CI verdict on this branch was RED on `governance-guard` and `verify` with a single root cause and was fixed at that root with no gate, test or document loosened: the port-wiring guard passed, but its own mutation suite carried a stale copy of the published number (`gov-cases-app-port-wiring.sh` swaps `ROOT_WIRED_PORTS = 11` for `10`), so once the document legitimately read `12` the mutation no-op'd and the case proving that a *justified* absence still passes reported a mismatch instead of an approval — the two counts in the mutation data were moved to the new measurement and nothing else was touched; the poisoned rows of the search relay are no longer silent: `GET /search/relay/dead-letters` (scope `search:relay-dead-letters:read`) reads `search_relay_consumed_events` in a single snapshot and publishes a reasoned verdict on delivery's own thresholds (1 warning, 10 critical, 86400s critical by age), wired in the production composition root rather than left as an optional port; 7 unit tests and 6 on real PostgreSQL, including a ledger fingerprint taken before and after the call to prove the read never writes, and a missing port answering 503 instead of an empty body because "I do not know" is not "nothing is poisoned". Two limits are published rather than hidden: the age is measured from `consumed_at` (the search ledger has no `updated_at`, so it is the age of the first attempt, stated in `alert.age_measured_from`) and `alert.gates_readiness` is `false` — a poisoned row pages a human, it does not pull search replicas out of routing. G5 is only PARTIALLY closed and the rest is named, not silently missing: requeue (wave 2) and acknowledgement (wave 3), in the same order delivery took (ADR-026 §4.24 / §4.27); a poisoned row is still terminal; earlier the same day — M2-07 G3 wave 2 (CLM-0246) — `matching_outbox`, `order_outbox` and `search_outbox` get the same in-row retry tracking as wave 1: two columns in contract SQL and Drizzle schema, one reversible `0002_outbox_retry_tracking` migration per service marked `@wasla-upgrade-proof: all-non-baseline`, `recordDeliveryFailure` implemented and `markPublished` incrementing `attempts` while clearing `last_error`; one integration test per service on real PostgreSQL plus the migration reversibility/upgrade-with-data suites and schema-drift 19/19 each; measured after the change: 11 of 13 outbox tables record attempts in the row. The last two — `dispatch_outbox` and `marketplace_outbox` — are deliberately NOT included and the reason is measured, not assumed: neither producing service has a drain adapter at all (`ls services/dispatch/src/outbox/` and `services/marketplace/src/outbox/` do not exist); their rows are pulled by relay consumers in `delivery` and `search`, so nothing in the producing service ever marks a row published or failed and the two columns would have no writer. Their retry state already lives in `*_relay_checkpoint` / `*_relay_consumed_events` and, for delivery, a full DLQ lifecycle; closing G3 for them needs a decision about where the record belongs, not another mechanical migration; earlier the same day — M2-07 G3 wave 1 (CLM-0245) — in-row retry tracking for 5 of the 10 outbox tables that lacked it: `attempts INTEGER NOT NULL DEFAULT 0` + `last_error TEXT` added to `customer_outbox`, `driver_outbox`, `geo_outbox`, `identity_outbox`, `delivery_outbox` in contract SQL, Drizzle schema and a reversible migration each (`0002_`/delivery `0004_outbox_retry_tracking`, `@wasla-upgrade-proof: all-non-baseline`); the optional `OutboxDrainStore.recordDeliveryFailure` is now implemented in all five adapters, and `markPublished` increments `attempts` and clears `last_error`, so a delivery failure is durable in the row instead of living only in the in-memory `DrainReport.failed`; one integration test per service against real PostgreSQL asserts attempts=1 + last_error set + published_at NULL after a failed drain then attempts=2 + last_error NULL after a successful one (25 tests green across the 5 files); no retry scheduler, no backoff and no quarantine are claimed — G3 is the record, not the policy; the 5 remaining tables (dispatch, marketplace, matching, orders, search) keep the previous behaviour; earlier — M2-07 G1 wave 3 implementation (CLM-0243) — `delivery` + `matching` + `negotiations` + `orders` + `search` outbox adapters: delivery uses `outbox_id` PK, matching/orders use `event_id` PK, negotiations implements `recordDeliveryFailure` (G3 closed), 20 integration tests; BASELINE.json updated: test_files 394→399; the first CI verdict on this branch was RED on three gates and was fixed at its roots with no gate or test loosened — (1) `negotiation_outbox.occurred_at` is `TIMESTAMPTZ NOT NULL` with **no** `DEFAULT now()` unlike `customer_outbox`/`order_outbox`, so the four negotiations test inserts failed with `23502` on both the clean and the shared-DB legs; the test now supplies `occurred_at` explicitly as every production writer does and `schema.sql` was left untouched, (2) eight dead imports under `noUnusedLocals` across the five test files (`Pool` in delivery/search, `DATABASE_URL` in all five, `createMatchingDb`/`createNegotiationDb`/`createOrderDb`) — CI showed only delivery because `pnpm -r` halts at the first failure, the other three were found by local measurement not by guessing, (3) a false evidence entry corrected by correction not erasure: `env-registry.json` declared the five test files `direct` readers of `DATABASE_URL` (179→184) though they never touch `process.env` — the real reader `pg-harness.ts` was already registered, so the count was restored to 179 and `.env.example`/`registry.generated.ts` regenerated from the registry; earlier — M2-07 G1 wave 2 implementation (CLM-0242) — `drivers` + `geography` + `identity` outbox adapters created with 4 integration tests each; `geography` adapter handles missing `aggregate_type`, `identity` adapter handles UUID `aggregate_id`; BASELINE.json updated: test_files 391→394; earlier — M2-07 G1 wave 1 implementation (CLM-0241) — `packages/outbox/` shared contract created: `OutboxRecord`, `OutboxDrainStore` with optional `recordDeliveryFailure` for G3 tables, `drainOutbox()`, `EventSinkPort`; `CustomerOutboxDrainStore` adapter maps `customer_outbox` to the contract; 6 unit tests + 4 integration tests on PostgreSQL; BASELINE.json updated: packages 52→53, test_files 389→391; earlier — M2-07 ADR-042 (CLM-0240) merged: shared outbox delivery contract + thin per-service adapters, not 9 independent drains; earlier — M2-07 status audit against actual evidence in main (CLM-0238) — M2-07 stays In Progress, NOT Completed and NOT Ready for Gate: its declared exit criterion "crash/retry/dedupe proof" IS met (CLM-0233, 3 integration tests), and G2 IS genuinely closed (verified in main: 5 tables index on `(id)`, delivery on `(outbox_id)`), but three blockers remain — (1) dependency M2-02 is BLOCKED on external credentials RENDER_API_KEY/RENDER_OWNER_ID and operating protocol §18 forbids completing an item whose dependency is not Completed, (2) G1 is High severity and open with 9 of 13 outbox tables having no delivery mechanism at all, (3) no M2-07_GATE.md exists; operating protocol line 118 forbids an automated agent from setting Completed, so the final move needs an Owner Decision; a CI finding not previously recorded: the post-merge run of a08645f on main was RED (verify + governance-guard failed check 4, deleted branch with an active claim) and self-healed at 596d415 when CLM-0237 was released — the pre-merge "35/35 green" was the PR branch, not main; four measurement defects in the M2-07 inventory corrected by addition: G1 wrongly included marketplace (2 relay consumers) and subscriptions (has drainSubscriptionOutbox) while omitting negotiations/search/delivery, G3 said 5 but measures 10 and omitted dispatch, G4 said 5 but measures 6 and omitted identity, G6 contradicted itself (5 vs "3 of 8", measures 3); §11 "What is NOT yet proven" was stale and is now reconciled with CLM-0233 and CLM-0232; earlier the same day — M2-07 outbox sequence parity for BIGSERIAL tables (CLM-0237) — closed debt gap G2: 6 outbox tables without `sequence_number`; `delivery_outbox` was already correct (index on `outbox_id`); for the other 5 tables (`customer_outbox`, `driver_outbox`, `geo_outbox`, `identity_outbox`, `search_outbox`), the BIGSERIAL `id` is already a monotonic sequence per ADR-037 §Scope, so the fix was to align the unpublished-events index from `(occurred_at)` to `(id)` and change the drivers repository ORDER BY from `(occurredAt, id)` to `(id)`; 5 contract SQL files, 5 Drizzle schema files, 5 migration files with rollback companions created; 5 upgrade-proof integration tests added (M0-34 pattern); env-registry.json updated with 2 new DATABASE_URL readers (geography, identity); derived artifacts regenerated; BASELINE.json test_files_tracked 384→389; schema-drift tests pass (customers 17/17, drivers 28/28, search 19/19); config schema all 8 gates pass; earlier the same day — M2-08b observability wired into all 13 Fastify services (CLM-0236) — each `server.ts` now calls `startTracing`/`registerMetrics`/`instrumentApp`/`addMetricsEndpoint` and `stopTracing` in its shutdown path; `@wasla/observability` added as a workspace dependency to all 13 service `package.json` files; `addMetricsEndpoint` fixed to register `/metrics` with `config.serviceIdentity: "open"` so the M1-04 central service-auth guard does not reject it; new `observability-wiring.test.ts` in customers service proves the wiring end-to-end (3/3 pass); purity tests in marketplace, reputation, and subscriptions updated to include `@wasla/observability` in expected dependency lists; BASELINE.json recalculated (test_files_tracked 383→384, lockfile SHA updated); declared gap "package not wired into 13 services" from M2-08/CLM-0235 is now closed; ADR-041 unchanged — alert manager and OTLP collector remain deferred to Stage B; earlier the same day — M2-08 observability stack CI fixes (CLM-0235) — fastify devDep upgraded from ^4.28.0 to ^5.12.1 to eliminate find-my-way@8.2.2 CVE-2026-47219 and GHSA-mrq3-vjjr-p77c; OTEL_EXPORTER_OTLP_ENDPOINT registered in env-registry.json with derived artifacts regenerated; middleware getRoute() updated to prefer routeOptions.url over deprecated routerPath; work claim scope expanded to include packages/config/ and .env.example; M2-08 observability stack COMPLETE (CLM-0235) — ADR-041 decides Prometheus metrics + OpenTelemetry tracing + pino logs; @wasla/observability package created with metrics.ts (http_requests_total, http_request_duration_seconds, http_requests_in_progress), middleware.ts (instrumentApp + addMetricsEndpoint), tracing.ts (opt-in via OTEL_EXPORTER_OTLP_ENDPOINT); 10/10 tests pass; SLI baseline defined: Availability ≥ 99%, Latency p95 ≤ 500ms, Error rate ≤ 5%, Throughput ≥ 100 req/s; package not yet wired into 13 services; alert manager and OTLP collector deferred to Stage B; M2-06 backup/restore/RPO-RTO drill COMPLETE (CLM-0234) — ADR-040 defines RPO/RTO targets: Production RPO ≤ 1h via PITR, RTO ≤ 15min; Staging/Dev RPO ≤ 24h via daily backups, RTO ≤ 30min/60min; drill script (scripts/m2-06-backup-restore-drill.mjs) executes pg_dump ← pg_restore ← 7-dimension catalog verification ← row-count verification per service; 13/13 services passed against Supabase pooler PostgreSQL 17.6; average backup 16.5s, average restore 15.7s, max cycle 41s (delivery); environmental finding: DROP DATABASE WITH (FORCE) required for cleanup; M2-07 crash/retry/dedupe proof COMPLETE (CLM-0233) — 3 new integration tests: concurrent dual-instance relay with SKIP LOCKED, crash mid-batch recovery, dedupe enforcement via UNIQUE constraint; proof document maps 5 requirements to all existing tests; M2-05C upgrade/repair drill COMPLETE (CLM-0232) — 13/13 services passed full migration cycle against Supabase pooler PostgreSQL 17.6: apply → 7-dimension catalog equivalence → rollback → clean check → re-apply; environmental finding: migrations use `public.` explicitly so schema isolation not possible, isolated databases used instead; pooler keeps connections alive after pool.end() — pg_terminate_backend workaround added; M2-07 crash/retry/dedupe proof unblocked; M2-07 outbox/tick/DLQ inventory complete (CLM-0231) — 13 outbox tables, 3 relay consumers, 3 ticks, 8 idempotency tables, DLQ lifecycle in delivery only, 8 gaps catalogued); M2-02D port compat — marketplace and subscriptions now read `PORT` first (CLM-0226); bots already had `PORT` fallback; all 16 units PORT-compatible; BLOCKED — CODE CHANGE REQUIRED resolved); M2-02D fix — SIGPIPE race in validate-render-config.sh fixed: grep -q . after pipe replaced with variable capture + [ -n ] check per RISK-0037); M2-02D — Render Free experimental compute: ADR-039 decides Render Free as M2-02 experimental compute target, not production; `render-oss/render` v1.9.1 provider pinned; 16 `render_web_service` resources (13 services + 3 bots) with Docker runtime_source; `terraform init`/`validate` pass; `terraform plan` shape verified locally with test credentials; `validate-render-config.sh` guard prevents secrets in files, verifies service coverage, blocks Render Postgres; `RENDER_SERVICE_INVENTORY.md` maps each unit to Render type; `terraform apply` blocked on `RENDER_API_KEY`/`RENDER_OWNER_ID` from env; CLM-0224); stale text cleanup — fixed contradictory «الشرطُ الثاني باقٍ» in execution board and present-tense exemption wording in M2-04_GATE.md; CLM-0223); docs cleanup — removed duplicate CLM-0220 paragraph from RISK-0046 entry; CLM-0222); M2-04 config exemption — packages/config/ blanket exemption narrowed to test-only in config_schema_semantics.py; production files now scanned, primitive reader readRawEnv uses env[name] (variable) which scanner can't match; 2 mutation tests in gov-cases-config-schema.sh prove raw process.env.X and env["X"] in packages/config/src/ fail the guard; implements RISK-0046 closing condition 2; CLM-0221); M2-04 exit gate — config-boot-fail.test.ts added to services/dispatch/src/__tests__/; boots the real service with broken env (DISPATCH_WAVE_SIZE=٣, abc, 0, DISPATCH_MAX_WAVES=لا رقمَ) and verifies ConfigError with variable name before port listen; implements RISK-0046 closing condition 1; CLM-0220); M2-02C — environment catalogue added to infra/environments/ with five environments (local/ci/development/staging/production), each with environment.json manifest; new CI check validate-environments.sh validates manifests, blocks in-memory fallback in staging/production, cross-references required_secrets with env-registry.json; 5 mutation tests in test-governance.sh section [ح]; CLM-0219); M2-02B fix — validate-terraform-scaffold.sh blind spots fixed: find precedence bug prevented .tf file scanning for secrets, postgresql:// pattern added; 4 regression tests added to test-governance.sh section [ز]; CLM-0218); M2-02B — Terraform scaffolding added to `infra/terraform/` with versions.tf, variables.tf, outputs.tf, backend.tf, and three environments (development/staging/production); new CI check `validate-terraform-scaffold.sh` validates structural integrity and blocks committed secrets; registered in `verify.sh` and `VERIFY_COMMAND.md`; ADR-038 decides Terraform for IaC and Supabase for managed PostgreSQL, compute platform deferred per SCALING.md; CLM-0216/CLM-0217); RISK-0037 closed — PR #235 merged, 35/35 CI green, regression tests in test-governance.sh section [ن], CLM-0214/0215 released; RISK-0012 mitigation continued — explicit `NOT NULL` added to `sequence_number` in all 7 contract SQL files for schema-drift parity; reputation drain-outbox test updated to reflect `sequence_number` ordering; CLM-0212 work claim added for baseline scope; subscriptions test fixed to import `DATABASE_URL` from `pg-harness.js` for M2-04 env-registry compliance); `ORDER BY sequence_number ASC` replaces the fragile `occurred_at, id` ordering that was non-deterministic under concurrent `now()` within a transaction; ADR-037 records the decision; drizzle migrations `0001_outbox_sequence_number.sql` and upgrade-proof tests per service per M0-34; `RISK-0012` → `mitigating`); last updated 2026-09-17 (M2-01 merged into `main` (`66fef14`) with `CLM-0195` released and the board row at Ready for Gate, not Completed; earlier the same day — third CI verdict read GREEN on all 32 required jobs, `image-supply-chain` included for the first time, with 48 findings still measured and published and 22 covered by one declared expiring guarded exception; earlier the second CI verdict read RED again on two targets the first two were hiding: the bundled `npm` was removed from the runtime layer, and the pre-compiled `esbuild` Go binary is now covered by a narrow, expiring, risk-linked and machine-enforced exception under new gate 10 — with two holes in that gate found by its own mutation suite before the push); last updated 2026-09-16 (M2-01 — the repository's first container image, SBOM and vulnerability gate, plus check 19 and a 32nd blocking context; first CI verdict read RED and its three root causes fixed; and two measured defects: two services that were tested yet had no start command at all, and dev dependencies that cannot leave the runtime image until the packages stop exporting TypeScript. Earlier: M1-05B wave 2 — five marketplace routes now prove store membership from the token inside the writing transaction; and the first version of that guard passed every in-memory test while locking every store owner out of their own store on a real engine); last updated again 2026-09-16 (M1-05B wave 4 — product lifecycle publish/archive/inventory-adjust now prove the actor from the token and store membership inside the writing transaction, `RISK-0042` finding 3 measured: 6 of 8 body actor fields bound, 2 remain by written platform-authority reason); last updated again 2026-09-16 (M1-06 — published OpenAPI contracts now declare security schemes and 401/403 responses; 75 operations across 8 boundaries, `RISK-0041` → `mitigating`); last updated again 2026-09-16 (M1-07 — bot internal routes now enforce service identity) · **`CLM-0244` (2026-09-20):** أُغلِقَت فجوةُ `G1` في وثائقِ الحقيقةِ بقياسٍ مُعادٍ من الشجرةِ على `main` عند `fac0c66` — 13 من 13 جدولَ صادرٍ لديها آليةُ توصيلٍ (9 محوّلاتِ drain على عقدِ `packages/outbox/` + 4 آلياتٍ سابقة)، فصُحِّحَ البندُ 8 في `M2-07_GATE.md` والصفُّ `G1` في الجردِ §10 بالإضافةِ لا بالمحوِ، وأُضيفَ §10.2 يُصرِّحُ بما لا يُدَّعى: `EventSinkPort` بلا تنفيذٍ إنتاجيٍّ ولا وسيطِ رسائلَ موصول. **البندُ 7 يبقى محجوبًا** على اعتمادِ `M2-02` الخارجيِّ، و`M2-07` يبقى `In Progress` لا `Completed`.
