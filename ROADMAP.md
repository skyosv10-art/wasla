...
**Last updated:** 2026-09-26 (`CLM-0358` — M5-16 review 3/N: PostgreSQL Store adapter — Drizzle schema, repository, in-memory store, constraints, migrate runner, 60 tests. Prior: `CLM-0357` scaffold + contracts. env-registry sorted, drizzle-orm ^0.45.2 (GHSA fix).; `CLM-0355` M5-15 closeout; PRs #463-#476 merged).
