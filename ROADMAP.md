...
**Last updated:** 2026-09-25 (`CLM-0350` — M5-13 Completed. Store Orders & Delivery service through 25 reviews, exit gate (inventory/payment E2E) passing in CI. All 5 deferred items raised: relay consumers, HTTP boundary, integration/CI, exit gate, generated migrations. RISK-0035 closed, RISK-0044 closed, RISK-0012 mitigated (ADR-037), RISK-0041 mitigated (M1-06 securitySchemes). Prior: `CLM-0349` — M4-06 Completed.
