...
**Last updated:** 2026-09-14 (M0-34 — a migration upgrade is now proven against a database that already holds rows, and a guard makes that proof mandatory for every non-baseline migration)
