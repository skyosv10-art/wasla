...
**Last updated:** 2026-09-23 (M3-06 corrective hardening closed · `CLM-0324` Released — PR #426/#427 merged (squash 6bf5df3 · gate §7 re-measured in PRODUCTION), CI green — رفعُ لافتِ الأوفلاين فوقَ الغلافِ بعدَ كشفِ عيبِ التخطيطِ في قياسِ PRODUCTION (M3-06_GATE.md §7) · Prior: M3-06 Completed · `CLM-0323` Released — PR #423/#424 merged (squash ac336a5 · e2e4a9e), CI green — i18n/accessibility/error/offline UX: مصفوفةُ قبولٍ مقيسةٌ ([FRONTEND_UX_QUALITY_SPEC.md](docs/01-product/FRONTEND_UX_QUALITY_SPEC.md) — 9 معايير × 3 تطبيقات) أُغلِقَت فيها الفجواتُ الأربعُ المقيسةُ (network_error/timeout · لافتُ أوفلاينٍ مترجَمٌ · `?locale=` مع lang/dir · تجاوبٌ 375px)؛ LOCAL ✅ (وحدةٌ 7/7×3 · E2E 35/34/30) · CI ✅ (PR #423 run 35869845415، مدموجٌ squash ac336a5) · PRODUCTION ✅ (متصفّحٌ حقيقيٌّ على العناوينِ المنشورةِ — M3-06_GATE.md §5، بحدودِ صدقٍ مُعلَنة). الأساسُ أُعيد توليدُه من تشغيلٍ حقيقي (469→475). بوّابةُ جودةِ الواجهاتِ الرابعةُ لروبوتِ التشغيلِ التالي: **M3-07** (runbook drill — قابلٌ للبدء). Prior: M3-06 started · CLM-0323 — القياسُ الأوليُّ والتنفيذُ. Prior: M3-09 Completed · CLM-0322 Released — PR #421/#422, CI green.
