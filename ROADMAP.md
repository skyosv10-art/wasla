...
**Last updated:** 2026-09-26 (`CLM-0360` — M5-16 review 5/N: Relay consumer — order.status_changed, 6 trigger states, checkpoint, dead-letter, 30 relay tests. Prior: `CLM-0359` HTTP layer + service identity. Prior: `CLM-0358` PostgreSQL Store adapter. Prior: `CLM-0357` scaffold + contracts. env-registry sorted, drizzle-orm ^0.45.2 (GHSA fix).; `CLM-0355` M5-15 closeout; PRs #463-#482 merged).
