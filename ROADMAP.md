...
**Last updated:** 2026-09-26 (`CLM-0356` — M5-16 Support & Escalation started: ADR-049 ticket model and service boundary — services/support port 8095, 5-state lifecycle, dispute evidence gate, reputation bridge. M5-15 Completed. Prior: `CLM-0355` M5-15 closeout; `CLM-0354` review 2/N Moderation screen; `CLM-0353` review 1/N Partners screen; PRs #463-#474 merged).
