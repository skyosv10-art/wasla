...
**Last updated:** 2026-09-26 (`CLM-0359` — M5-16 review 4/N: HTTP layer + service identity — Fastify app, 7 routes, ServiceAuth (3 scopes), authz-policy ops registered, OpenAPI v0.2.0 with x-wasla-service-auth. Prior: `CLM-0358` PostgreSQL Store adapter. Prior: `CLM-0357` scaffold + contracts. env-registry sorted, drizzle-orm ^0.45.2 (GHSA fix).; `CLM-0355` M5-15 closeout; PRs #463-#480 merged).
