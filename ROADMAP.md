...
**Last updated:** 2026-09-25 (`CLM-0351` — M5-14 Partner/Enterprise review 1/N. ADR-048 accepted: tenant = store, API credentials scoped to store, lifecycle state machine, audit trail. Partners service scaffolded with 32 unit tests. Governance: registered in migration-owners, env-registry, service auth enforcement, port wiring, config schema. Prior: `CLM-0350` — M5-13 Completed.
