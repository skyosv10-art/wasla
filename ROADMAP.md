...
**Last updated:** 2026-09-26 (`CLM-0361` — M5-16 review 6/N: Reputation bridge — dispute_resolved fact, ReputationBridgePort, in-memory bridge, wired to resolve handler. Prior: `CLM-0360` relay consumer. Prior: `CLM-0359` HTTP layer + service identity. Prior: `CLM-0358` PostgreSQL Store adapter. Prior: `CLM-0357` scaffold + contracts.; `CLM-0355` M5-15 closeout; PRs #463-#484 merged).
