...
**Last updated:** 2026-09-26 (`CLM-0354` — M5-15 Admin Operations full review 2/N: Moderation screen — store/product review decisions (approve/reject/suspend/reinstate/archive), product publish/archive, 7 unit tests. Added /moderation to routing table. APP_API_ROUTES counts updated (call sites 54→60). Prior: `CLM-0353` review 1/N Partners management screen merged; `CLM-0353` released to fix stale-claim gate on main; PRs #463-#469 merged).
