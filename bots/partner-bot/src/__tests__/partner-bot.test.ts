...
const ENV = {
  ...
  // M1-03 (ADR-035): مخزنُ الآثارِ صارَ مشترَكاً افتراضاً، فبناءٌ بلا وصلةٍ
  // يسقطُ عندَ الإقلاعِ بالقصدِ. ونمطُ الذاكرةِ يُطلَبُ هنا **صراحةً** — وهذا
  // هوَ عينُ ما يُقاسُ: أنَّ الاختيارَ مكتوبٌ لا موروثٌ بالسكوتِ.
