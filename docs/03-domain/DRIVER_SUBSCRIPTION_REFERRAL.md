...
سعر أو فاتورة أو استرداد · نص حر · واجهة مستخدم · كود خدمة أو `src/`.

---

> **Scope:** نموذج مجال اشتراك السائق والإحالة في Phase 10، للمراجعة 1/6 (عقود ووثائق وحزمة أنواع فقط).
>
