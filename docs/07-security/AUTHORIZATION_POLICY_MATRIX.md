...
| العملياتُ المفروضةُ | `ENFORCED_OPERATIONS = 143` | مساراتٌ تُعلِنُ `scoped(...)` |
| المساراتُ المفتوحةُ | `OPEN_ROUTES = 17` | مساراتٌ تُعلِنُ `OPEN` |
| المساراتُ بلا صلاحيّةٍ ولا `OPEN` | `0` | البابُ 2 من الفحصِ 16 |
| الصلاحيّاتُ المفروضةُ | `ENFORCED_SCOPES = 119` | اتّحادُ صلاحيّاتِ العملياتِ |
...
| العملياتُ غيرُ المُصنَّفةِ | `UNCLASSIFIED_OPERATION_COUNT = 91` | `143 − 52` |
