...
| `negotiations-exit-gate-e2e` | `@wasla/negotiation-e2e` | `wasla_negotiation_e2e` | Phase 08 · MR 6/6 (**بوابة خروج المرحلة**): خيطُ مفاوضةٍ كاملٌ على قاعدةٍ حقيقيّةٍ — جولةٌ تُقبَل فيصير للطلبِ سعرٌ متعاقدٌ عليه، ولا دورَ معلَّقٌ ثانٍ |
| `reputation-db-integration` | `@wasla/reputation-service` | `wasla_reputation_test` | Phase 09 · مستودعاتُ السمعةِ وصندوقُ صادرِها أمام محرّكٍ حقيقيّ |
| `subscriptions-db-integration` | `@wasla/subscriptions-service` | `wasla_subscriptions_test` | Phase 10 · دفترُ الاستحقاقِ والإحالاتُ أمام محرّكٍ حقيقيّ |
| `subscription-exit-gate-e2e` | `@wasla/subscription-e2e` | `wasla_subscription_e2e` | Phase 10 · MR 6/6 (**بوابة خروج المرحلة**): الحالاتُ الأربعُ تُبلَغ بمضيِّ الزمنِ ونبضةٍ حقيقيّةٍ، ووقائعُ الإحالةِ تُقرأ من صندوقِ صادرِ **مُنتِجها**، وإحالةٌ دون النصابِ لا صفَّ مكافأةٍ لها ([تفصيل](PHASE10_EXIT_GATE_E2E.md)) |
| `marketplace-db-integration` | `@wasla/marketplace-service` | `wasla_marketplace_test` | Phase 11 · MR 4/6: التسعَ عشرةَ عمليّةً على قاعدةٍ حقيقيّةٍ، والمساراتُ العشرُ الكاتبةُ بمنعِ تكرارٍ موصولٍ (نفسُ المفتاحِ ⇒ نفسُ الحقولِ · مفتاحٌ مُعادٌ لمُدخلٍ آخرَ ⇒ 409)، وذرّيّةُ القرارِ، وصندوقُ الصادر |
| `marketplace-exit-gate-e2e` | `@wasla/marketplace-e2e` | `wasla_marketplace_e2e` | Phase 11 · MR 6/6 (**بوابة خروج المرحلة**): الرحلةُ التسعُ عبرَ الشبكةِ على مُستمعٍ حقيقيّ، وكلُّ صفٍّ في الصادرِ يُصدَّق **غلافاً وحمولةً** على `contracts/events.json` المقروءِ من القرص، وإعادةٌ تُعيد الحالةَ والحقولَ (لا البايتات — RISK-0013)، وترتيبُ المعاملةِ الواحدةِ ترتيبُ الكتابةِ، و**غيابُ الناقلِ مُثبَّتاً** ([تفصيل](PHASE11_EXIT_GATE_E2E.md)) |

**والجدولُ أعلاه كان قد بات:** بينَ المرحلتَينِ 08 و11 أُضيفت **خمسُ** وظائفَ قاعدةٍ إلى `.gitlab-ci.yml` ولم تُدخَل هذا الفهرس (`negotiations-exit-gate-e2e` · `reputation-db-integration` · `subscriptions-db-integration` · `subscription-exit-gate-e2e` · `marketplace-db-integration`)، فأُدخلت في هذه المراجعةِ مع السادسةِ الجديدة. والعددُ المقيسُ اليومَ **20 وظيفةً** تُوسِّع `.db-integration-base` — مقروءاً من الملفِّ لا من هذه الوثيقة، وهو الرقمُ الذي يجب أن يُقابله سطرٌ هنا في كلِّ مراجعةٍ تُضيف وظيفة.
