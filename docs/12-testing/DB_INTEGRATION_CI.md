...
>
> **Last Updated:** 2026-08-20 · **Status:** Active · **Related:** [.gitlab-ci.yml](../../.gitlab-ci.yml) · [ADR-005](../15-decisions/ADR-005-identity-service-implementation-stack.md) · [ADR-006](../15-decisions/ADR-006-geography-localization-stack-and-model.md) · [DEFINITION_OF_DONE](../00-rules/DEFINITION_OF_DONE.md)
...
2. لُفّ ملف الاختبار بـ`describe.skipIf(!process.env.DATABASE_URL)` وطبّق `contracts/schema.sql` داخله.
