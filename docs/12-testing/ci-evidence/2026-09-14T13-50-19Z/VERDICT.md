# دليلُ CI — 2026-09-14T13-50-19Z

- **المُزوِّد:** `github` · **الموضوع:** skyosv10-art/wasla · **المرجع:** `fix/m0-35-gate-schema-serialization`
- **التشغيل:** [34851685707](https://github.com/skyosv10-art/wasla/actions/runs/34851685707)
- **حالةُ التشغيلِ كما جاءت:** `completed/failure`
- **عددُ الوظائف:** 31 · **بدأت فعلاً:** 0
- **توزيعُ الحالات:** `failure`=31
- **أسبابُ ما لم يبدأ:** `account_billing_blocked`=31
...
| `db-integration (search, @wasla/search-service, wasla_search_test)` | `completed` | `failure` | `started_at+steps+annotation` | `account_billing_blocked` |
