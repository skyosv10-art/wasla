...
الاختبارات:       **2197 اختباراً** (+1 متروك بقصد) في **133 ملفاً** — لقطة 2026-08-23 بعد Phase 08 · MR 1/6
...
## 14. Phase 08 (Negotiation & Chat) — قيد التنفيذ 🔄 (بدأت 2026-08-23) · MR 1/6 مدفوعة من ستّ
...
### ما يجب أن يُقرأ أولاً قبل MR 2/6

1. [ADR-013](../15-decisions/ADR-013-negotiation-chat-agreement-boundary-and-tick-driven-expiry.md) كاملاً — خصوصاً «البدائل المرفوضة» و«مؤجَّل صراحةً».
2. [NEGOTIATION_CHAT.md](../03-domain/NEGOTIATION_CHAT.md) §3 (مسار الحياة) و§4 (القواعد التي تحرسها القاعدة).
3. `services/negotiations/contracts/schema.sql` — القيود الاثنان والعشرون **هي المواصفة**، ومُهيّئ الذاكرة في 2/6 يُطبّقها بأسمائها كي يُفشل الاختبار بنفس الاسم الذي ستُفشله به القاعدة.
4. [PUSH_DOCUMENTATION_RULE](../00-rules/PUSH_DOCUMENTATION_RULE.md) و[GIT_RULES](../00-rules/GIT_RULES.md) — لا دفع كودٍ بلا وثيقة في **نفس** الالتزام.
5. **وقبل كل شيء: §2-أ** — حصّة دقائق CI منتهية، فأنبوب أي مراجعة أحمر لأسباب تشغيلية. **لا تُدمَج مراجعة بأنبوب أحمر**؛ يلزم تدخّل مالك الحساب أوّلاً.
