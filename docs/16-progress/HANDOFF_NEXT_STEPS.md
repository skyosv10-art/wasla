...
| ~~5/6~~ | ~~مستهلكُ وقائعِ السمعة + ناشرُ الصادر + `subscription_idempotency` + تأهيلُ الإحالةِ ومكافأتُها~~ | ✅ **تمّت** — 205 سريعاً + 54 تكاملاً · عيبُ الصفِّ البائتِ في التأهّلِ مُصلَحٌ · **التفصيلُ في 18.10** و[SUBSCRIPTION_EVENTS](../02-architecture/SUBSCRIPTION_EVENTS.md) · وإعادةُ تشغيلِ **مسارِ HTTP** مؤجَّلةٌ إلى 6/6 بقصد (18.10-ز) |
...
### 18.10 ما أنجزته MR 5/6 بالضبط — الحدُّ الحدثيُّ في الاتجاهَين
