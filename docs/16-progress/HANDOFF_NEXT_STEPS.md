...
>
> **Last Updated:** 2026-09-08 (**Phase 11 (Marketplace Foundation) — 6/6 مدموجةٌ وبوّابةُ الخروجِ خضراءُ محلّيّاً · الإغلاقُ قرارُ المالكِ**): MR 4/6 ([38c73e4](https://github.com/skyosv10-art/wasla/commit/38c73e4)) · 5/6 ([b8fc903](https://github.com/skyosv10-art/wasla/commit/b8fc903)) · 6/6 ([c461a2d](https://github.com/skyosv10-art/wasla/commit/c461a2d)) مدموجةٌ في `main` عبر [MR !112](https://gitlab.com/uxxxu/wasla/-/merge_requests/112) · البوّابةُ `packages/marketplace-e2e` 6/6 ناجحةٌ · **316 وحدةً + 118 تكاملاً** · `pnpm -r test` **3836/0** · النقلُ إلى `Completed` مشروطٌ بدليلِ خطِّ CI (`RISK-0001`) وغيابِ الناقلِ (دَينُ الطور 09). *مصالحةٌ توثيقيّةٌ: كانَ النصُّ متخلّفاً (قال Phase 10 قيد التنفيذ).*
>
> **(تاريخيّ): Last Updated:** 2026-08-24 (**Phase 10 (Driver Subscription & Referral) قيد التنفيذ 🔄 — MR 1/6 من ستّ**: عقودُ `services/subscriptions/contracts/` مجمَّدةٌ (مخطَّطٌ بعشرةِ جداول · أحدَ عشرَ مساراً واثنتا عشرةَ عمليّةً على 8093 · ستّةُ أحداث · سبعةَ عشرَ رمزَ خطأ) وحزمةُ `@wasla/contracts-subscription` مولَّدةٌ منها مع **26 حارسَ انحرافٍ ناجحاً**، و[ADR-015](../15-decisions/ADR-015-driver-subscription-entitlement-ledger-and-derived-referral-rewards.md) يُثبّت الحدَّ. **لا كودَ خدمةٍ بعد بقرارٍ مُعلَن.** ما يجب أن تفعله المراجعةُ التالية بالحرفِ في **§18**)
>
...
| ~~6/6~~ | ~~بوابةُ الخروجِ + إعادةُ تشغيلِ مسارِ HTTP~~ | ✅ **تمّت** — [!77](https://gitlab.com/uxxxu/wasla/-/merge_requests/77) · 3 في البوابةِ + 205 سريعاً + 62 تكاملاً · عيبُ تركيبٍ إنتاجيٍّ في `http/server.ts` كُشف وأُصلح · **التفصيلُ في 18.11** و[PHASE10_EXIT_GATE_E2E](../12-testing/PHASE10_EXIT_GATE_E2E.md) |
...
## 18. Phase 10 (Driver Subscription & Referral) — **مكتملة ✅ · ستُّ مراجعاتٍ من ستّ · بوابةُ الخروجِ اجتازت** · وشروطُ الدخولِ إلى الطور 11 في 18.12 · والحالةُ الجاريةُ للطور 11 في §19
...
>
> **المراجعاتُ المدمجة:** MR 1/6 — [!70](https://gitlab.com/uxxxu/wasla/-/merge_requests/70) (commit `7dd64147` · merge `e069d90b`) وتثبيتُ الدليل [!71](https://gitlab.com/uxxxu/wasla/-/merge_requests/71) · **MR 2/6 — [!72](https://gitlab.com/uxxxu/wasla/-/merge_requests/72)** (commit `56d1a6c7` · merge `0f0d0ccc` · 2026-08-24) وتثبيتُ الدليل [!73](https://gitlab.com/uxxxu/wasla/-/merge_requests/73). · **MR 3/6 — [!74](https://gitlab.com/uxxxu/wasla/-/merge_requests/74)** (commit `9517d38a` · merge `bfafb62e` · 2026-08-24 · استمراريّةُ Postgres والمُهاجرة) · **MR 4/6 — [!75](https://gitlab.com/uxxxu/wasla/-/merge_requests/75)** (commit `4ab26b62` · 2026-08-24 · طبقةُ التطبيقِ والمعاملةُ الواحدةُ وHTTP على 8093 · مفتوحةٌ للمراجعة).
>
> **الحالة عند هذا التسليم:** العقودُ مجمَّدةٌ (ومُصحَّحةٌ بملحقٍ، انظر 18.3-د) و**طبقةُ المجالِ نقيّةٌ** و**الاستمراريّةُ على محرّكٍ حقيقيّ** و**الخدمةُ ترفع فعلاً على المنفذ 8093**: الاثنتا عشرةَ عمليّةً مخدومةٌ، والمُدّةُ والانتقالُ والصفُّ المُتحقِّقُ تُكتب في **معاملةٍ واحدة**، والصفُّ **مؤشِّرٌ مُشتقٌّ** لا مصدرَ حقيقةٍ ثانياً، ووضعُ الذاكرةِ يُجيب 503 بصراحةٍ و`/health` يبقى 200 `degraded`. **وما زال غائباً:** مخزنُ منعِ التكرار · مستهلكُ وقائعِ السمعةِ وناشرُ الصادر · بوابةُ الخروج. من يقرأ هذا القسمَ ليعمل: مدخلُك **18.6** (المُنجَزُ) ثمّ **18.8** (نطاقُ 5/6) وقبلَهما **18.2** — القواعدُ الأربعُ لا تُنقَض.
...
### 18.6 ما أنجزته MR 4/6 بالضبط — طبقةُ التطبيقِ والمعاملةُ الواحدةُ وHTTP على **8093**

**النطاقُ الذي كُتب لها في 18.7 نُفِّذ بحرفِه**، والتفصيلُ الكاملُ في وثيقةٍ جديدة: [SUBSCRIPTION_HTTP.md](../04-api/SUBSCRIPTION_HTTP.md). وفيما يلي ما لا يُغني عنه غيرُه:

**أ) اثنا عشرَ ملفّاً جديداً وحدٌّ واحدٌ لكلِّ مسؤوليّة**

| الملف | مسؤوليّته | ما لا يفعله |
|---|---|---|
| `app/runtime.ts` | `SubscriptionServices {subscriptions, referrals}` — المِقبضُ الوحيدُ لمعالجِ المسار | لا يُصدِّر `db` ولا `Pool` فلا معالجَ يفتح معاملة |
| `app/subscriptions.ts` | حالاتُ الاستخدام: بدءُ تجربةٍ · تفعيلٌ · إعادةُ حسابٍ · قراءةٌ · مُدَدٌ · نبضة | لا يعرف Fastify ولا رمزَ حالةٍ HTTP |
| `app/referrals.ts` · `app/referral-code.ts` | المطالبةُ وقراءةُ الرمز · اشتقاقُ الرمزِ بـsha256 | لا يمنح مكافأةً (5/6) ولا حلقةَ تصادُم |
| `app/sync.ts` | **مزامنةُ المؤشِّرِ**: يشتقُّ من الدفترِ ويكتب **كلَّ وثبةٍ في الطريق** | لا يكتب حالةً يُرسلها عميل |
| `db/unit-of-work.ts` | **الموضعُ الوحيدُ** الذي يفتح معاملةً | لا منطقَ مجالٍ |
| `db/projection.ts` | صفُّ `subscriptions` المُتحقِّق (**أوّلُ `UPDATE` مشروعٍ في الطور**) | لا يلمس `subscription_periods` |
| `db/referrals.ts` · `db/constraints.ts` | مخزنُ الإحالةِ · ترجمةُ أسماءِ القيودِ إلى رموزِ مجال | لا يُخمّن قيداً غيرَ مُترجَم (يصعد خاماً ⇒ 500) |
| `http/app.ts` · `requests.ts` · `mappers.ts` · `errors.ts` · `server.ts` | 12 مساراً مرقوماً · تحقّقُ الأجسام · نموذجٌ ⇒ سلك · مُترجِمُ خطأٍ واحد · **القارئُ الوحيدُ** لـ`process.env` وللساعة | لا `try/catch` في معالج · لا قرارَ مجالٍ في الحدّ |
| `domain/identifiers.ts` | حرّاسُ `WASLA_PUBLIC_ID_PATTERN` و`REFERRAL_CODE_PATTERN` | يُنادى من الحدِّ **ومن** التطبيقِ بقصد |

**ب) عيبُ إنتاجٍ حقيقيٌّ كُشف وأُصلح — الوثبةُ التي تتجاوز حالةً وسطى.** صفٌّ يقول `trial` ودفترٌ يقول `community` (يقع حين لا تركض نبضةٌ طويلاً): `[trial, community]` **ليس زوجاً مُعلَناً**، فكانت `recompute` ترفع 409 و`tick` تعدّ `failures: 1` **إلى الأبد** — سائقٌ لاهٍ عنه النبضُ يبقى معلَّقاً في `trial` بلا مخرج. و**لم يُضَف الزوجُ إلى العقد** (ذلك يُسقط واقعتَين من التاريخ) بل أُضيفت `transitionPath()` — بحثُ عرضٍ أوّلاً في الحافّاتِ المُعلَنة — و`app/sync.ts` يكتب **وثبةً لكلِّ حافّةٍ في نفسِ المعاملة** (`trial→expired` ثمّ `expired→community`)، ومصدرُ المُدّةِ و`periodId` **على الوثبةِ الأخيرةِ وحدَها**. مُثبَتٌ بخمسةِ اختباراتٍ سريعةٍ وباختبارِ تكاملٍ يُخرِج `state_sequence = 3` وثلاثةَ صفوفِ انتقال.

**ج) انحرافُ عقدٍ حقيقيٌّ في تفاصيلِ الخطأ أُصلح.** `ErrorResponse.details` مجموعةٌ **مُغلقة** (`additionalProperties:false`)، وكان الحدُّ يُصدر خمسةَ مفاتيحَ غيرَ مُعلَنةٍ (`from_state` · `to_state` · `period_source` · `referral_state` · `rejection_reason`) — **جوابُ خطأٍ يحقُّ لمستهلكٍ صارمٍ أن يرفضَه**. فحُذفت، والمعلومةُ حُفظت في مفتاحَين مُعلَنَين (`state` · و`expected` برموزٍ مقروءةٍ بالآلة: `transition:<from>><to>` · `period_source:<x>` · `rejection:<x>`)، **ولا عربيّةَ في قيمةِ حقلٍ مُتعاقَدٍ عليه**. وحارسٌ جديدٌ يقرأ `details.properties` **من العقدِ على القرص** ويقابله بمصدرِ `errors.ts` فيشترط التساوي، وثانٍ يمنع عودةَ المفاتيحِ الخمس.

**د) تصحيحُ تعليقٍ مُضلِّلٍ في `db/schema.ts`** كان يقول إنّ رمزَ الإحالةِ يُبذَر عند أوّلِ قراءةٍ؛ والصوابُ أنّه يُبذَر **داخلَ معاملةِ `startTrial`**، و`GET /referrals/codes/{owner}` قراءةٌ محضةٌ تُجيب 404 إن غاب. (توثيقُ فحصٍ لا تعديلَ سلوكٍ — وقاعدةُ الدفعِ تُوجب ذكرَه.)

**هـ) الأرقامُ المقيسةُ (محلّيّاً · 2026-08-24)**: الحزمةُ السريعةُ **174 ناجحاً · 10 ملفّات** (كانت 116) · التكاملُ على Postgres حقيقيٍّ **41 ناجحاً · 3 ملفّات** (`http.integration` **20** جديدةٌ · `ledger` 12 · `migrate` 9) · `pnpm -r test` على المستودعِ كاملاً **0 فاشل** · `pnpm typecheck` للخدمةِ نظيف. **وكلُّ رقمٍ محلّيٌّ لا من CI** (`ci_quota_exceeded` — انحرافٌ مُعلَنٌ وفق §2-أ).

**و) ما لم تفعله 4/6 بقصد**: لا مخزنَ منعِ تكرارٍ (المفتاحُ يُتحقَّق شكلاً ولا يُخزَّن ⇒ `SUBSCRIPTION_IDEMPOTENCY_KEY_REUSED` لا يُصدَر بعد) · لا تأهيلَ إحالةٍ ولا مكافأةً (`pending` و`reward: null`) · لا صندوقَ صادرٍ · ولا مالَ: `payment_reference` **معرّفٌ معتمٌ** يُخزَّن ولا يُفسَّر.

### 18.7 (تاريخيّ) نطاقُ MR 4/6 كما كُتب قبل تنفيذها — **نُفِّذ كلُّه، والمُنجَزُ في 18.6**
...
### 18.8 بقيّةُ الطريقِ في هذا الطور
...
| ~~4/6~~ | ~~طبقةُ HTTP على **8093** + نبضةٌ + صفُّ `subscriptions` مُشتقّاً + معاملةٌ واحدة~~ | ✅ **تمّت** — 174 سريعاً + 41 تكاملاً · عيبُ الوثبةِ الوسطى مُصلَحٌ · التفصيلُ في 18.6 و[SUBSCRIPTION_HTTP](../04-api/SUBSCRIPTION_HTTP.md) |
| ~~5/6~~ | ~~مستهلكُ وقائعِ السمعة + ناشرُ الصادر + `subscription_idempotency` + تأهيلُ الإحالةِ ومكافأتُها~~ | ✅ **تمّت** — [!76](https://gitlab.com/uxxxu/wasla/-/merge_requests/76) · commit `314cd30c` · 205 سريعاً + 54 تكاملاً · عيبُ الصفِّ البائتِ في التأهّلِ مُصلَحٌ · **التفصيلُ في 18.10** و[SUBSCRIPTION_EVENTS](../02-architecture/SUBSCRIPTION_EVENTS.md) · وإعادةُ تشغيلِ **مسارِ HTTP** مؤجَّلةٌ إلى 6/6 بقصد (18.10-ز) |
| **6/6** | **بوابةُ الخروج**: حزمةُ e2e ترفع الخدمةَ **وخدمةَ السمعةِ الحقيقيّةَ** بساعةٍ محقونة · **وإعادةُ تشغيلِ مسارِ HTTP** بوصلِ `PostgresIdempotencyStore` بمعالجاتِ الكتابةِ الثلاثة | الجملتان تُثبتان لا تُوصفان: الأربعُ حالاتٍ بنبضةٍ حقيقيّة · إحالةٌ لا تُكافأ لأنّ الوقائعَ لم تبلغ الحدَّ · وإعادةُ المفتاحِ تُعيد **نفسَ البايتات** لا جسماً يُعاد حسابُه |

### 18.9 الدَّينُ المُعلَنُ المنقولُ (اقرأه قبل أن تبني عليه)
...
6. ~~**دَينُ MR 3/6 على 4/6**: لا صفَّ `subscriptions` مُتحقِّقاً ولا معاملةً~~ ✅ **سُدَّ في MR 4/6** (18.6-أ)، ~~ولا حلقةَ إعادةٍ عند تزامنِ تسلسلِ الانتقالات~~ ✅ **سُدَّ في MR 5/6**: `write` تُعيد المحاولةَ وتُرجِع `{value, attempts}`. **والباقي منه**: `subscriptions-db-integration` مُضافةٌ ولم تركض بعد (18.5-ج · حصّةٌ مستنفدة) · **ولا اختبارَ تزامنٍ** يُشبع `MAX_TRANSITION_ATTEMPTS` (الحلقةُ مُختبَرةٌ بمسارِ نجاحٍ لا بتصادمٍ حقيقيّ).
7. **دَينُ MR 4/6 — ما سُدَّ منه وما بقي**: ~~ذرّيّةُ المعاملةِ غيرُ مُثبَتةٍ بفشلٍ مُصطنعٍ في منتصفِها~~ ✅ **سُدَّ في MR 5/6** بـ`TransactionProbe` واختبارِ تكاملٍ يقرأ الجداولَ الأربعةَ فيجدها فارغةً. **والباقي**: لا `projection.integration.test.ts` مستقلّاً (مساواةُ المؤشِّرِ للاشتقاقِ مُثبَتةٌ **عَبَر HTTP** وعبرَ ملفِّ الأحداثِ لا على المخزنِ مباشرةً). وفجواتُ العقدِ **موصوفةٌ الآن بالكاملِ ومُحرَّسةٌ** في [SUBSCRIPTION_EVENTS §8](../02-architecture/SUBSCRIPTION_EVENTS.md): `payment_reference` (`minLength: 1` مقابل `4..64`) · أربعةُ رموزِ خطأٍ ناقصةٌ من التعداد · رمزٌ خامسٌ محلّيٌّ `SUBSCRIPTION_IDEMPOTENCY_KEY_REUSED` · وقاعدةُ `errors.md` 5 التي تذكر مفتاحاً غيرَ قابلٍ للاستعمالِ لأنّ المخطَّطاتِ مُغلَقة. **الحزمةُ مُجمَّدةٌ فلم تُعدَّل، والتصحيحُ مِلكُ مراجعةٍ تملك العقد.**
8. **دَينٌ جديدٌ من MR 5/6**: **لا ناقلَ أحداثٍ ولا مُنادٍ دوريّاً** لـ`drainSubscriptionOutbox` (المرحلة 09 · `EventSinkPort` هو موضعُ الوصل) · **إعادةُ تشغيلِ مسارِ HTTP مؤجَّلةٌ إلى 6/6** (المخزنُ يعمل ويُستعمَل في المستهلكِ وحدَه) · و`TickOutcome.referralsQualified`/`rewardsApplied` **صفرانِ ثابتان** لأنّ التأهّلَ يقع في المستهلكِ لا في النبضة.

### 18.10 ما أنجزته MR 5/6 بالضبط — الحدُّ الحدثيُّ في الاتجاهَين ([!76](https://gitlab.com/uxxxu/wasla/-/merge_requests/76) · commit `314cd30c`)

**التفصيلُ الكاملُ في وثيقةٍ جديدة: [SUBSCRIPTION_EVENTS.md](../02-architecture/SUBSCRIPTION_EVENTS.md).** وهذا ما لا يُغني عنه غيرُه:

**أ) سبعةُ ملفّاتٍ جديدةٍ وحدٌّ واحدٌ لكلِّ مسؤوليّة**

| الملف | مسؤوليّته | ما لا يفعله |
|---|---|---|
| `domain/events.ts` (403) | ستّةُ أنواعِ أحداثٍ بمُغلَّفٍ واحدٍ · مصانعُ **نقيّة** | لا يقرأ ساعةً ولا يُولّد `uuid` (يستلم `meta`) |
| `db/outbox.ts` (233) | إلحاقٌ · مُطالبةٌ بـ`FOR UPDATE SKIP LOCKED` · تعليمُ نشرٍ · تسجيلُ فشل | لا يُسلّم بنفسِه ولا يعرف ناقلاً |
| `app/events.ts` (343) | `toOutboxDraft` · `transitionEvent` · `EventSinkPort` · `drainSubscriptionOutbox` | لا يفتح معاملةً (وحدةُ العملِ تملكها) |
| `db/idempotency.ts` (211) | `read`/`remember` — الجوابُ المخزَّنُ يُعاد بحرفِه | **لا `UPDATE` أبداً** |
| `app/idempotency.ts` (79) | `fingerprint` — sha256 لتمثيلٍ قانونيّ | لا يتأثّر بترتيبِ المفاتيح · **يحفظ** ترتيبَ المصفوفات |
| `app/facts.ts` (496) | `ReputationFactConsumer` — واقعةٌ ⇒ عدٌّ ⇒ تأهّلٌ ⇒ **مُدّةٌ في الدفتر** | لا رصيدَ ولا نقاطَ ولا مال |
| `http/mappers.ts` (+3 أغلفة) | `toGrantResultWire` · `toRecomputeResultWire` · `toReferralClaimResultWire` | `toStateWire` بقي على `GET` وحدَه |

ومرآةُ Drizzle صارت **10/10 جداولَ** (`referral_rewards` · `subscription_idempotency` · `subscription_outbox`) و`NOT_MIRRORED_TABLES` **فارغةٌ**.

**ب) صندوقُ صادرٍ لا نشرٌ داخلَ المعاملة.** النشرُ المباشرُ يُنتج إحدى كذبتَين: حدثٌ نُشِر لمعاملةٍ تراجعت، أو معاملةٌ ارتكزت لم يُعلَم بها أحد. فالحدثُ صفٌّ في نفسِ معاملةِ التغيير، والضمانُ المُعلَنُ **مرّةً على الأقلّ لا مرّةً واحدةً بالضبط** — ومنعُ التكرارِ مسؤوليّةُ المستهلكِ بالعقد، وخدمتُنا تُطبّقه على ما تستهلكه. والفشلُ **يُسجَّل ولا يُرفَع** فدفعةٌ من مئةٍ لا يُسقطها حدثٌ عاطبٌ واحد.

**ج) عيبُ إنتاجٍ حقيقيٌّ كشفه اختبارُ التكاملِ وأُصلح — الصفُّ البائتُ يمنع حقّاً.** المستهلكُ كان يحكم على حالةِ المُحيلِ من صفِّه المُتحقِّق؛ ومَن دفع في يومِ تجربتِه الأوّلِ يبقى صفُّه `trial` حتّى تركض نبضةٌ، **وهو سارٍ فعلاً بالاشتقاق**. فكان التأهّلُ يُرفَض بـ`referrer_not_active` رفضاً كاذباً ثمّ تُغلَق نافذةُ الثلاثين يوماً — **حقُّ سائقٍ يضيع بسببِ تأخّرِ مهمّةٍ دوريّة، بلا خطأٍ ولا سجلٍّ**. الإصلاح: الحالةُ تُشتقُّ **الآن** من الدفترِ داخلَ نفسِ المعاملةِ بـ`syncFromLedger`، فيبقى موضعُ الاشتقاقِ واحداً (القرار 2). والبديلُ الأرخصُ الخاطئُ كان تصحيحَ توقّعِ الاختبارِ — يُخفي العيبَ ويتركه في الإنتاج.

**د) انحرافُ عقدٍ ثالثٌ في **أجسامِ** الكتابةِ أُصلح.** العقدُ يُلزم `{subscription, period, duplicate}` في المنحِ و`{subscription, rebuilt}` في إعادةِ الحسابِ و`{referral, duplicate}` في المطالبة، والحدُّ كان يُرسل الحالةَ وحدَها ⇒ حقولٌ إلزاميّةٌ غائبةٌ يحقُّ لمستهلكٍ صارمٍ أن يرفضَ الجوابَ لغيابها. والحارسُ الجديدُ **يقرأ `required:` من العقدِ على القرص** ويقابله بمفاتيحِ المُحوِّلِ وبعددِ نداءاتِ الإرسالِ في كلِّ مسار.

**هـ) الذرّيّةُ مُثبَتةٌ لا موصوفةٌ.** `TransactionProbe` يُحقَن في وحدةِ العملِ (لا في منطقِ المجال) فيرفع خطأً بعدَ المُدّةِ وقبلَ الانتقال، والاختبارُ يقرأ الجداولَ الأربعةَ بـSQL خامٍ فيجدها فارغةً كلَّها.

**و) `attempts` تزيد في النجاحِ أيضاً** لا في الفشلِ وحدَه: صفٌّ منشورٌ بصفرِ محاولاتٍ يُقرَأ «نُشِر بلا أن يُحاوَل» — نصٌّ بلا معنى في تحقيقٍ بعد حادثة. **وعيبٌ صغيرٌ كشفه المحرّكُ الحقيقيّ:** `event_id` و`source_event_id` عمودا `uuid`، فمُعرِّفاتُ الاختبارِ اللطيفةُ (`evt-1`) تُسقط الإدخالَ بـ`22P02` في منتصفِ معاملةٍ — اختبارٌ نقيٌّ لا يستطيع كشفَ هذا لأنّه لا يعرف أنواعَ الأعمدة، فأُضيف `sequentialUuidGenerator`.

**ز) ما لم تفعله 5/6 بقصد**: **إعادةُ تشغيلِ مسارِ HTTP** (تخزينُ جوابِ المسارِ وإعادةُ بايتاتِه) **مؤجَّلةٌ إلى 6/6** — المخزنُ يعمل ومُختبَرٌ ويستعمله **مستهلكُ الوقائعِ وحدَه**، وأجسامُ الكتابةِ تُجيب `duplicate: true` من قيدِ القاعدةِ لا من صفٍّ محفوظ · **ولا ناقلَ ولا مُنادٍ دوريّ** (المرحلة 09) · ولا مالَ.

**ح) الأرقامُ المقيسةُ (محلّيّاً · 2026-08-24)**: السريعةُ **205 ناجحاً · 11 ملفّاً** (كانت 174) · التكاملُ على Postgres حقيقيٍّ **54 ناجحاً · 4 ملفّات** (كانت 41 · جديدُها `events.integration` **13**) · `pnpm -r test` **0 فاشل** · `pnpm typecheck` نظيف. **وكلُّ رقمٍ محلّيٌّ لا من CI** (`ci_quota_exceeded` — انحرافٌ مُعلَنٌ وفق §2-أ).

### 18.11 ما أنجزته MR 6/6 بالضبط — إعادةُ تشغيلِ مسارِ HTTP وبوابةُ الخروج ([!77](https://gitlab.com/uxxxu/wasla/-/merge_requests/77) · فرع `feat/subscriptions-phase10-exit-gate`)

**أ) إعادةُ تشغيلِ مسارِ HTTP — الدَّينُ الذي أجّلته 5/6 بقصدٍ سُدَّ.** أربعةُ مساراتِ كتابةٍ صارت تُعيد **الجوابَ المحفوظَ حرفاً بحرف**: `POST /subscriptions` · `POST /subscriptions/{driver}/activate` · `POST /subscriptions/{driver}/recompute` · `POST /referrals`. والبناءُ في `app/idempotency.ts`: `IdempotencyEnvelope<T>` يحمل المفتاحَ و`routeKey` وبصمةَ الطلبِ ودالّةَ `present` التي تُترجم النتيجةَ إلى `(حالةٌ، جسمٌ)`، و`replayGuard` **أوّلُ سطرٍ** في مغلَّفِ `uow.write` و`rememberOutcome` **آخرُه**. ولمَ داخلَ المعاملةِ لا حولَها؟ لأنّ نافذةً بين «قرّرتُ» و«حفظتُ» يمرّ فيها طلبٌ ثانٍ فيمنح مُدّةً ثانية — والمعاملةُ هي الشيءُ الوحيدُ الذي يمنع ذلك بلا قُفلٍ في التطبيق.

**ب) `ReplayedResponse` إشارةُ تحكّمٍ لا خطأ.** تُرفَع من `replayGuard`/`rememberOutcome` وتُترجَم في **موضعٍ واحد**: أوّلُ فرعٍ في `sendSubscriptionError`. فلا معالجٌ يحتاج `try` — و`__tests__/http-drift.test.ts` يحرس ذلك حرفيّاً (`try` واحدةٌ في `app.ts` كلِّه). والحالةُ والجسمُ يُعادان **كما حُفظا**: لا إعادةَ تحويلٍ ولا إعادةَ حسابٍ، وهذا هو معنى الإعادة.

**ج) `POST /subscriptions/tick` مُستثنىً بقصدٍ موثَّقٍ في الكود.** النبضةُ ليست عمليّةَ مُتَّصلٍ على مورد؛ إعادةُ إرسالِها **يجب** أن تعمل من جديد، وحفظُ جوابِها كان سيجعل نبضةً مُعادةً تُعيد أرقامَ نبضةٍ ماضية — وهو رقمٌ يُقرأ في لوحةٍ فيُصدَّق.

**د) الحالةُ والجسمُ مكتوبان مرّتَين بقصد.** في `.send(...)` داخلَ المعالجِ وفي `present(...)` داخلَ المغلَّف. والسببُ حرسٌ قائم: `http-drift.test.ts` يقرأ **نصَّ** المعالجِ ويُوكِّد `send(toGrantResultWire(` مرّتَين و`send(toStateWire(` مرّةً وهكذا؛ ودالّةٌ مشتركةٌ كانت ستُخفي أخصَّ سطرٍ في المسارِ عن حارسِه. والتكرارُ مُعلَّقٌ عليه في الموضعَين، فمن يُوحّدهما يقرأ لماذا لا يفعل.

**هـ) بوابةُ الخروج — `packages/subscription-e2e`.** ترفع خدمةَ الاشتراكِ بتركيبِها الإنتاجيِّ على **Postgres حقيقيٍّ** وخدمةَ السمعةِ الحقيقيّةَ على مُهيئي ذاكرةٍ، كلتاهما مُستمعٌ حقيقيٌّ بمنفذٍ يمنحه النظام، وبينهما `MovableClock` تُقدَّم **بأيّامٍ مُعلَنةٍ** لأنّ الحالاتَ الأربعَ تحتاج 22 يوماً وبوابةٌ بساعةِ نظامٍ لا تركض أبداً. وثلاثةُ اختباراتٍ: (1) الحالاتُ الأربعُ بنبضتَينِ حقيقيَّتَين، والدفترُ **مُدّتانِ لا أربعٌ** لأنّ `expired` و`community` تُشتقّان من فراغِ التغطية؛ (2) وقائعُ تُسجَّل في محرّكِ السمعةِ ثمّ تُقرأ حمولتُها **من صندوقِ صادرِه** وتُمرَّر كما هي إلى `ReputationFactConsumer`، فتبقى إحالةٌ بأربعِ وقائعَ من نصابِ خمسٍ `pending` و`referral_rewards` صفرٌ؛ (3) مفتاحٌ مُعادٌ على الشبكةِ يُعيد نفسَ البايتاتِ بلا مُدّةٍ ولا صادرٍ ثانٍ، ونفسُ المفتاحِ لجسمٍ آخرَ `409` مُسمّىً. **ولا حمولةَ حدثٍ واحدةً مكتوبةً بيد الاختبار.**

**و) عيبُ تركيبٍ إنتاجيٌّ على `main` كُشف وأُصلح.** `src/http/server.ts` كان يبني `new SubscriptionService(uow, systemClock)` بلا الوسيطِ الثالثِ الإلزاميِّ (`IdGenerator`) — أي أنّ **جذرَ التركيبِ الإنتاجيَّ وحدَه** لم يكن يجتاز `typecheck`، بينما كلُّ اختبارٍ يبنيه بيدِه فيمرّ. أُصلح بـ`uuidIdGenerator` من `app/runtime.js`. وهذا **عيبٌ في الكودِ لا في الاختبار**، ويُعلَن هنا لأنّ من يقرأ «5/6 كانت خضراء» يستحقّ أن يعرف أنّ الخضرةَ لم تكن تشمل جذرَ التركيب.

**ز) سبعةُ اختباراتِ تكاملٍ قائمةٍ صارت تُعيد `409` بحقّ.** `http.integration.test.ts` كان يُعيد استعمالَ **مفتاحٍ واحدٍ** لأجسامٍ مختلفة، وهو الآن تعارضٌ صادقٌ (`SUBSCRIPTION_IDEMPOTENCY_KEY_REUSED`). فصار المفتاحُ دالّةً تُولّد مفتاحاً لكلِّ طلبٍ، بتعليقٍ يشرح أنّ الذي تغيّر هو الاختبارُ لا العقد. **من يرى هذا الفرقَ في `git diff` فليقرأ التعليقَ قبل أن يظنّه تراجعاً.**

**ح) وظيفةُ CI جديدةٌ واحدة** — `subscription-exit-gate-e2e` بقاعدةٍ مستقلّةٍ `wasla_subscription_e2e`. وهي **ضروريّةٌ** لا تجميليّة: نمطُ الذاكرةِ في هذه الخدمةِ يردّ `503` عن قصد، فالبوابةُ تتخطّى نفسَها بلا `DATABASE_URL` — وبوابةٌ تتخطّى نفسَها بلا وظيفةٍ تُشغّلها ليست بوابة.

**ط) الأرقامُ المقيسةُ (محلّيّاً · 2026-08-24)**: البوابةُ **3 ناجحاً · ملفٌّ واحد** · التكاملُ **62 ناجحاً · 5 ملفّات** (كان 54 · 4؛ الجديدُ `idempotency-replay.integration` **8**) · السريعةُ **205 · 11** بلا تغيُّر · المستودعُ كاملاً **3092 ناجحاً · 4 مُتخطّىً** بلا `DATABASE_URL` · `pnpm -r typecheck` نظيف. **وحصّةُ CI مستنفدةٌ (`ci_quota_exceeded`) فكلُّ رقمٍ هنا مقيسٌ محلّيّاً** — وهذا انحرافٌ عن الأصلِ (الرقمُ يُثبَّت من خطٍّ أخضر) يُعلَن ولا يُخفى؛ وأوّلُ ما يفعله من يملك الحصّةَ: تشغيلُ الخطِّ وتثبيتُ أرقامِ الوظيفةِ الجديدةِ في [PHASE10_EXIT_GATE_E2E §7](../12-testing/PHASE10_EXIT_GATE_E2E.md).

### 18.12 شروطُ الدخولِ إلى الطور 11 (Marketplace Foundation) — اقرأها قبل أن تكتب سطراً

> **تصحيحُ سهوٍ (2026-08-24):** كان عنوانُ هذا البندِ يسمّي الطورَ 11 «Partner & Catalog»، وهو خطأ. الطورُ 11 في [الخارطة](ROADMAP.md) هو **Marketplace Foundation** وبوابتُه «مستخدم قائم ينشئ Store + منتج + طلب مراجعة»؛ و**Partner / Enterprise** هو الطورُ **14**. صُحِّح العنوانُ ولم يُمسَّ أيٌّ من بنودِه الخمسة، لأنّ الشروطَ نفسَها صحيحةٌ ومستقلّةٌ عن الاسم.

1. **الدَّينُ المنقولُ من الطور 10 لا يُبنى عليه بصمت**: لا ناقلَ أحداثٍ ولا مُنادٍ دوريّاً لـ`drainSubscriptionOutbox` (موضعُ الوصل: `EventSinkPort` من المرحلة 09) · ولا مسارَ HTTP لوقائعِ السمعةِ في خدمةِ الاشتراك (المستهلكُ يُنادى من ناقلٍ لم يُبنَ) · و`TickOutcome.referralsQualified` يبقى مقروءاً بحدِّ الدُّفعة. فمن يحتاج تسليماً فعليّاً بين الخدمتَين **يبني الناقلَ أوّلاً** ولا يستدعي المستهلكَ من مكانٍ ثالث.
2. **حصّةُ CI**: أوّلُ عملٍ في الطور 11 هو تشغيلُ خطٍّ كاملٍ على `main` وتثبيتُ الأرقام. أرقامُ الطورَين 09 و10 كلُّها محلّيّةٌ حتّى ذلك الحين.
3. **القواعدُ الأربعُ في 18.2 تبقى سارية** على أيِّ كودٍ يمسّ حدَّ الاشتراك: الحالةُ لا تُخزَّن · التجديدُ ليس انتقالاً · لا مالَ في هذا الحدّ (المالُ Phase 17) · `community` أرضيّةٌ لا عقوبة.
4. **البندُ الأحمرُ خارج النطاق ما زال مفتوحاً**: تكامل `services/drivers` على محرّكٍ حقيقيّ (§14) — وهو أقدمُ من هذا الطور ولا يُغلقه اجتيازُ بوابتِه.
5. **حزمةُ العقدِ `packages/contracts/subscription` مُجمَّدةٌ** ولم تُلمَس في المراجعتَين الأخيرتَين؛ وفجواتُها موصوفةٌ في [SUBSCRIPTION_EVENTS §8](../02-architecture/SUBSCRIPTION_EVENTS.md). فمن يحتاج حقلاً جديداً يفتح ADR لا يُعدّل مولَّداً.

---

## 19. Phase 11 (Marketplace Foundation) — **جارية 🔄 · المراجعاتُ 1/6 و2/6 و3/6 مدفوعة** (العقودُ وحزمةُ الأنواعِ وADR-016 · ثمّ طبقةُ المجالِ النقيّة · ثمّ **الاستمراريّةُ على Postgres حقيقيّ**)

### 19.1 ما وقع في المراجعة 1/6 بالضبط

**عقودٌ وأنواعٌ ووثائق. لا سطرَ كودٍ خدميٍّ واحد، ولا مُهاجرةَ تُطبَّق، ولا منفذَ يُرفَع.**

| الأثر | الموضع | الحجم المقيس |
|---|---|---|
| المخطط الكنسيّ | `services/marketplace/contracts/schema.sql` | 394 سطراً · **10 جداول** |
| الأحداث | `services/marketplace/contracts/events.json` | 422 سطراً · **13 حدثاً** |
| الواجهة | `services/marketplace/contracts/api.openapi.yml` | **15 مساراً · 19 عمليّة** · المنفذ 8094 |
| الأخطاء | `services/marketplace/contracts/errors.md` | **24 رمزاً** في 5 أصناف |
| حزمة الأنواع | `packages/contracts/marketplace/` | `@wasla/contracts-marketplace` · **46 اختباراً ناجحاً** |
| القرار | [ADR-016](../15-decisions/ADR-016-marketplace-store-ownership-catalog-and-moderation-boundary.md) | 10 قرارات · 10 بدائل مرفوضة |
| المجال | [MARKETPLACE_CATALOG.md](../03-domain/MARKETPLACE_CATALOG.md) | جداولُ الانتقالِ المُعلَنةُ + حدودُ الملكيّة |

### 19.2 أربعُ قواعدَ لا تُخالَف في بقيّة الطور

1. **الحالةُ إسقاطٌ لا مصدرٌ.** `stores.state` و`products.moderation_state` يُعادُ بناؤهما من `store_reviews`/`product_reviews` بلا خسارة. أيُّ كتابةٍ في العمودِ بلا سطرٍ في الدفترِ **عيبٌ** لا اختصار.
2. **لا نبضةَ في هذا الحدّ.** الاعتمادُ قرارُ إنسان؛ ولا `next_review_at` ولا `is_stale` ولا اعتمادٌ آليٌّ بمرورِ مدّة. طابورٌ متأخّرٌ مشكلةُ موارد، لا خللٌ يُداوى بالكود.
3. **الظهورُ يُحسَب عند القراءة** من أربعةِ شروطٍ عبر `isProductVisible` في الحزمة — لا عمودَ ولا حدثَ ولا رمزَ خطأٍ جامع.
4. **السعرُ بيانُ كتالوجٍ لا مال.** عددٌ صحيحٌ بالهللاتِ و`SAR` فقط؛ ولا سعرَ في حمولةِ حدثٍ أبداً؛ ولا حقلَ رسومٍ أو عمولةٍ أو فاتورة (الطور 17).

### 19.3 المراجعاتُ الثلاثُ الباقية (الترتيبُ مُلزم · والمشطوبُ مدفوع)

- ~~**2/6** طبقةُ المجالِ النقيّةُ في `services/marketplace/src/domain/`~~ — ✅ **مدفوعة 2026-08-24** (التفصيلُ في §19.5 أعلاه). والباقياتُ أربعٌ:
- ~~**3/6** الاستمراريّةُ في `src/db/`: مُهاجرةٌ تُطبّق `schema.sql` حرفاً · مستودعاتٌ · اختباراتٌ على Postgres حقيقيّ~~ — ✅ **مدفوعة 2026-08-25** (التفصيلُ في §19.6 أدناه · الوثيقةُ المعماريّة [MARKETPLACE_PERSISTENCE](../02-architecture/MARKETPLACE_PERSISTENCE.md) · دليلُ المحرّكِ المحلّيّ [LOCAL_POSTGRES_FOR_TESTS](../14-runbooks/LOCAL_POSTGRES_FOR_TESTS.md) · المنفذ 55432). **والباقياتُ ثلاثٌ والترتيبُ ما زال مُلزماً.**
- **4/6** طبقةُ التطبيقِ وHTTP على **8094**: معاملةٌ واحدةٌ لكلِّ كتابةٍ · `Idempotency-Key` بجوابٍ محفوظٍ · الأخطاءُ الأربعةُ والعشرون مُقترنةٌ برموزِ HTTP.
- **5/6** الأحداثُ وصندوقُ الصادرِ في **نفسِ المعاملة** + زرعُ التصنيفاتِ الأوّليّة.
- **6/6** بوابةُ الخروجِ **مُثبَتةً لا موصوفةً**: حزمةُ E2E تُنشئ متجراً من مُعرّفٍ قائمٍ ثمّ منتجاً ثمّ تطلب المراجعةَ وتُثبت أنّ الظهورَ لا يقع قبل قرارِ مُراجع.

### 19.4 ما يجب أن يعرفه من يكمل

1. **حصّةُ CI ما زالت مستنفدة** (`ci_quota_exceeded`): كلُّ أرقامِ الطورِ **محلّيّةٌ** — 46/46 في `packages/contracts/marketplace` و**153/153** في الحزمةِ السريعةِ لـ`services/marketplace` (كانت 125 في 2/6) و**44/44 اختبارَ تكاملٍ على Postgres حقيقيٍّ** خارجَ تلك الحزمةِ بإعدادٍ منفصل، و`pnpm -r test` **3291 · 4 مُتخطّاة**. انحرافٌ مُعلَنٌ لا مُخفى وفق §2-أ، ولا يُغلَق إلّا برصيدِ دقائق.
2. **لا وظيفةَ CI جديدةً في المراجعتَين 1/6 و2/6** بقصد: `build-test` تغطّي كلَّ الحزم، فتدخل حزمةُ العقدِ وحزمةُ الخدمةِ تحتها بلا تعديلٍ على التهيئة.
3. **الحرّاسُ يفحصون السطحَ الآليَّ لا النثر:** متنُ العقدِ يذكر `NUMERIC` و`commission` و`quantity_reserved` و`is_visible` **في سياقِ النفي**؛ فأيُّ حارسٍ جديدٍ يقرأ نصّاً خامّاً سيفشل زوراً. اقرأ أسماءَ الأعمدةِ ومفاتيحَ العقودِ كما في `boundary.test.ts`.
4. **دَينُ ناقلِ الأحداثِ منقولٌ من الطور 09 ولم يُقضَ:** صندوقُ صادرِ السوقِ بنفسِ شكلِ صندوقِ الاشتراك **بقصد**، كي يُبنى ناقلٌ واحدٌ لكلِّ الصناديقِ لا خمسةُ نواقل.
5. **المنافذُ محجوزة:** 8087 الطلبات · 8088 المطابقة · 8089 الإسناد · 8090 السائقون · 8091 التفاوض · 8092 السمعة · 8093 الاشتراك · **8094 السوق**. وحارسُ الحزمةِ يمنع ظهورَ أيِّ `809x` آخرَ في عقودِ السوق.


### 19.5 المراجعة 2/6 — طبقةُ المجالِ النقيّةُ (مدفوعة)

**ما وقع:** حزمةُ خدمةٍ جديدةٌ `@wasla/marketplace-service` بـ**طبقةِ مجالٍ وحدَها** — لا `db/` ولا `http/` ولا مُهاجرةٌ ولا منفذٌ مرفوع. اثنا عشرَ ملفّاً في `src/domain/`:

| الملفّ | ما يحرسه |
|---|---|
| `contract-sets.ts` | بابٌ **واحدٌ** إلى حزمةِ العقد: لا قائمةَ أعضاءٍ تُعاد كتابتُها في الخدمة. |
| `transitions.ts` | الجدولان يُقرآن من العقدِ بالاسم · القرارُ يُترجَم إلى حالةٍ (`reinstated → approved`) · الانتقالُ يُفحَص **قبل** السبب. |
| `state.ts` | `deriveStoreState` و`deriveProductModerationState` طيّاً فوق الدفترِ مع رفضِ الدفترِ الفاسدِ (تسلسلٌ · اتّفاقُ `from_state` · شكلُ الفاعلِ · زمنٌ لا يرجع) و`first_approved_at` عند **أوّلِ** اعتماد. |
| `visibility.ts` | أربعةُ شروطٍ بأربعةِ رموزٍ متمايزةٍ · `productVisibilityBlockers` يُعيد **كلَّ** العوائقِ بترتيبٍ ثابت. |
| `inventory.ts` | فرقٌ موقَّعٌ غيرُ صفريٍّ · `quantity_after` يُحسَب لا يُرسَل · طيٌّ يُقارَن **بكلِّ سطرٍ** لا بالمجموعِ الأخير. |
| `staff.ts` | مالكٌ واحدٌ فعّالٌ لا يُعدَّل ولا يُزال · إزالةٌ بختمِ `removed_at` + `removed_by` معاً. |
| `catalog.ts` | المسوّدةُ دائماً `draft` · تصنيفُ المنتجِ **ورقةٌ** · اللاحقةُ تُقفَل بعد أوّلِ اعتماد · حدُّ متجرِ المالكِ يُحسَب على كلِّ ما ليس مُؤرشَفاً. |
| `pricing.ts` | عددٌ صحيحٌ بالهللاتِ و`SAR` وحدَها · **لا دالّةَ تنسيقٍ** بقصد. |
| `identifiers.ts` · `errors.ts` · `time.ts` · `model.ts` | صيغُ المُعرّفاتِ من العقد · الرمزُ والحالةُ المُشتقّةُ و`details` بعشرةِ مفاتيحَ مُقفَلةٍ **مُشتقّةٍ من `ErrorResponse` نوعاً** · تحويلُ زمنٍ **بلا ساعة** · نماذجُ قراءةٍ فقط. |

**الاختبارات:** **125 ناجحاً · 9 ملفّات** محلّيّاً، منها **21 حارساً سلبيّاً على النقاء** (`purity.test.ts`) بقوائمِ استثناءٍ **فارغةٍ بالنصّ** ومحروسةٍ **موجَباً**: لا ساعةَ ولا مُجدولَ ولا `expires_at` · لا بيئةَ ولا شبكةَ ولا نظامَ ملفاتٍ · لا `pg` ولا Drizzle ولا Fastify ولا SQL نصّاً · لا حذفَ صلباً ولا بحثاً · لا حقلَ ظهورٍ مُخزَّناً ولا كسرَ في السعر · والتبعيّةُ المُعلَنةُ **واحدةٌ** هي حزمةُ العقد. والمستودعُ كاملاً **3263 ناجحاً** = خطُّ الأساس 3138 **+125 بالضبط**.

**ما يلزم من يكمل في 3/6 بالحرف:** حارسُ النقاءِ سيسقط **موجَباً** أوّلَ ما يُضاف `src/db/`، وهذا مقصودٌ. القوائمُ تُحدَّث **بأسماءِ الملفّات** (`DB_AWARE_FILES` و`FS_READING_FILES` و`ENV_READING_FILES`) ولا يُوسَّع نمطٌ ولا يُبطَل حارسٌ ولا يُحذَف اختبار؛ ويُحدَّث كذلك اختبارُ «كلُّ ملفٍّ يقيم في `domain/` إلّا بابَ الحزمة». ومنعُ SQL النصّيِّ ومنعُ الحذفِ الصلبِ يبقيان **بلا استثناء**.


### 19.6 المراجعة 3/6 — الاستمراريّةُ على Postgres حقيقيّ (مدفوعة)

**ما وقع:** ثلاثةَ عشرَ ملفّاً جديداً في `services/marketplace/src/db/` (‏1943 سطراً) وثمانيةُ ملفّاتِ اختبارٍ جديدةٍ، و**`src/domain/` لم يُلمَس بحرفٍ واحد** خلا ثلاثِ مصانعِ أخطاءٍ تُخدَم من القيودِ المُسمّاة. ولو احتاجت الاستمراريّةُ تعديلَ قاعدةِ عملٍ لكان معناه أنّ المجالَ كُتب على ظنٍّ في شكلِ التخزين — وهو أوّلُ ما يُبطل دعوى 2/6.

| القرار | ما يحرسه · والبديلُ الرخيصُ المرفوض |
|---|---|
| `migrate.ts` = `pool.query(readSchemaContract())` | العقدُ يُنفَّذ **نصّاً**؛ لا Drizzle ولا `drizzle-kit`. مُهاجرةٌ مُولَّدةٌ من المرآةِ كانت ستجعل المرآةَ **مصدرَ الحقيقةِ** فيصير الانحرافُ مستحيلَ الكشفِ لأنّ الطرفَين صارا واحداً. `BEGIN/COMMIT` + `IF NOT EXISTS` ⇒ **عكوسٌ وقابلٌ للتكرار**. |
| **لا بذرَ في المُهاجرة** | التصنيفاتُ الأولى لـ5/6؛ بذرةٌ اليومَ تُثبّت شجرةً لم يُقرّرها أحدٌ ثمّ يصير حذفُها تعديلَ بياناتٍ في الإنتاج لا تعديلَ كود. |
| `NOT_MIRRORED_TABLES` = `["marketplace_idempotency","marketplace_outbox"]` | **ثمانيةٌ في المرآةِ من عشرة**؛ كلٌّ يهبط في مراجعتِه (4/6 · 5/6). مرآةٌ لجدولٍ لا يكتبه أحدٌ بعد **وعدٌ بلا حارس** يتباعد بصمتٍ حتى أوّلِ كتابة. والمُهاجرةُ تُنشئ الجدولَين. |
| القيودُ **غيرُ المُسمّاةِ** لا تُعكَس، والحارسُ يقارن المُسمّاةَ وحدَها | Postgres يُسمّي المجهولَ بنفسِه بأسماءٍ لا يُعتمد عليها بين إصدارَين؛ حارسٌ يقارنها يفشل زوراً عند ترقيةٍ ثمّ يُعلَّم بالتخفيف. |
| `WHERE …_sequence < :sequence` + `coalesce(first_approved_at, …)` | قرارٌ متأخّرٌ لا يُرجِع الحالةَ ولا يرمي — صفرُ صفوفٍ و`undefined`. `UPDATE` بلا شرطٍ كان سيجعل **ترتيبَ الوصولِ** هو ما يُقرّر حالةَ المتجر. وأوّلُ اعتمادٍ لا يُطمَس أبداً (القرار 7). |
| التسلسلُ **يُمرَّر** لا `MAX+1` · وإعادةُ المحاولةِ على `SEQUENCE_RACE_CONSTRAINTS` وحدَها (`MAX_DECISION_ATTEMPTS = 3`) | `MAX+1` يقرأ ويكتب في نافذتَين فقرارانِ متزامنانِ يكتبان صفّاً مكسوراً بلا شكوى. وإعادةٌ عامّةٌ كانت ستُعيد المحاولةَ على لاحقةٍ مأخوذةٍ ثلاثاً ثمّ تُخبر المستخدمَ بنفسِ الرفض: ثلاثةُ أضعافِ الحملِ وصفرُ فائدة. |
| `gen_random_uuid()` في SQL · `DEFAULT now()` للطوابعِ التقنيّة · و`decided_at`/`occurred_at`/`added_at` **وسائطُ** | مسوّداتُ المجالِ بلا مُعرّفٍ أصلاً، والتوليدُ في `src/` كان سيُسقط حارسَ العشوائيّةِ أو يفتح استثناءً بلا حاجة. ولحظةُ قرارِ مُعتدِلٍ حقيقةٌ عنه لا عن الخادمِ الذي كتبها (القرار 2). |
| الإزالةُ `UPDATE … WHERE removed_at IS NULL` | خَتمٌ لا حذف؛ والشرطُ هو ما يمنع خَتماً ثانياً يُعيد كتابةَ تاريخِ إزالةٍ وقعت. **لا `DELETE` في `src/` كلِّه.** |
| `translateConstraint` تُعيد `undefined` للمجهول | ستُّ ترجماتٍ مُعلَنةٌ وما ليس فيها **يصعد خاماً**؛ مُترجِمٌ يبتلع كلَّ شيءٍ برمزٍ عامٍّ كان سيُخفي مفتاحاً أجنبيّاً مفقوداً سنةً وراء رسالةٍ مُهذَّبة. |

**ثلاثةُ أشياءَ ظهرت أثناءَ التنفيذِ يجب أن يعرفها من يكمل — وهي أهمُّ من القرارات:**

1. **اثنتا عشرةَ حالةَ اختبارٍ سقطت في أوّلِ ركضةٍ على محرّكٍ حقيقيّ (31/43)، وكانت الاختباراتُ هي الخطأ لا الكود.** المتجرُ يُنشَأ بالتسلسل **1 بلا صفِّ دفتر** (الإنشاءُ ليس قراراً مُراجَعاً)، فأوّلُ صفٍّ في `store_reviews` تسلسلُه **2** و`from_state` فيه `draft`؛ ونظيرُه في `product_reviews` أوّلُ صفٍّ **2** و`PRODUCT_MODERATION_ALLOWED_TRANSITIONS` **لا تحمل `approved → rejected`**. وأرخصُ إصلاحٍ كان تغييرَ `STORE_INITIAL_SEQUENCE` ليُوافق الاختبارَ، فتصير أوّلُ قراءةٍ للدفترِ بعد سنةٍ لا تعرف هل الصفُّ 1 هو الإنشاءُ أم أوّلُ قرار. **فمن يكتب اختباراً هنا يبني سلاسلَه من `STORE_ALLOWED_TRANSITIONS` لا من حَدسِه.**
2. **`rejects.toThrow(/اسم القيد/)` نمطٌ لا يفحص ما يقول.** Drizzle يلفّ خطأَ `pg` في خطأٍ رسالتُه `Failed query: insert into …` واسمُ القيدِ في سلسلةِ `cause`. فأُضيفت `rejectingConstraint(promise)` في `pg-harness.ts` تستعمل **`constraintOf` نفسَها** التي تستعملها الترجمةُ في الإنتاج ⇒ **اسمٌ باسمٍ لا نصٌّ بنمط**. من يضيف فحصَ قيدٍ يستعملها.
3. **`ux_stores_slug_lower` حرسٌ مزدوجٌ لا وحيد.** لاحقةٌ بحرفٍ كبيرٍ **لا تصل الفهرسَ أصلاً**: يرفضها `CHECK (slug ~ '^[a-z][a-z0-9-]{2,47}$')` في العقد ويرفضها `assertStoreSlug` قبله. فالملفُّ يفحص **الحقيقتَين معاً** (تكرارٌ ⇒ `STORE_SLUG_TAKEN` · حرفٌ كبيرٌ ⇒ صيغةٌ مرفوضة) بدلاً من ادّعاءِ فحصٍ لا يقع.

**وحرّاسُ النقاءِ حُدِّثت بالأسماءِ ولم تُبطَل** كما وعد شرحُها في 2/6: سقطت **ستُّ حالاتٍ موجَبةٍ** أوّلَ ما أُضيف `db/`، فصارت `ENV_READING_FILES = ["db/migrate-cli.ts"]` (قارئُ البيئةِ **الوحيدُ** في الخدمةِ كلِّها) و`FS_READING_FILES = ["db/migrate.ts"]` **قائمةً منفصلة** (قائمةٌ واحدةٌ للاثنَين كانت ستُبيح `process.env` لمن يحتاج القرصَ وحدَه) و`DB_AWARE_FILES` ثمانيةً **كلُّها تحت `db/`**، و`PERSISTENCE_FILES` ثلاثةَ عشرَ اسماً **مكتوبةً حرفاً لا بنمطِ `db/**`** كي يُرى الملفُّ الجديدُ في مُراجعةٍ لا يمرَّ لأنّ مجلَّدَه مأذونٌ له. و`REAL_CLOCK_FILES` و`HTTP_AWARE_FILES` **فارغتان**، و**منعُ SQL النصّيِّ والحذفِ الصلبِ بلا استثناءٍ واحد** — مقيسٌ لا مأمول. وملاحظةٌ تمنع فهماً خاطئاً: `new Date(arg)` مسموحٌ والممنوعُ `Date.now()` و`new Date()` بلا وسيط.

**الأرقامُ المقيسةُ محلّيّاً (2026-08-25):** الحزمةُ السريعة **153 · 10 ملفّات** (+28 = `schema-drift.test.ts`) · التكاملُ **44 · 6 ملفّات** على محرّكٍ حقيقيّ (متاجر 10 · منتجات 8 · مخزون 7 · طاقم 7 · **ذرّيّة 7** · مُهاجرة 5) · `pnpm -r test` **3291 · 4 مُتخطّاة** (الأساسُ 3263 ⇒ **+28 بالضبط**) · `pnpm -r typecheck` نظيف.

**ما يلزم من يكمل في 4/6 بالحرف:**

1. **وحدةُ العملِ موجودةٌ فلا تُبنَ ثانيةً.** `MarketplaceUnitOfWork.write` تضمّ الدفترَ والإسقاطَ في معاملةٍ واحدةٍ وتُعيد المحاولةَ على السباق؛ ومعالجُ مسارٍ يفتح معاملةً بنفسِه يُنشئ مساراً ثانياً للكتابةِ بلا حارسٍ لسباقِ التسلسل.
2. **مرآةُ `marketplace_idempotency` تُضاف في 4/6 وتُحذَف من `NOT_MIRRORED_TABLES`** — والحارسُ الموجَبُ في `schema-drift.test.ts` سيسقط إن نُسي، وهذا مقصود. والجدولُ **موجودٌ في القاعدةِ فعلاً** لأنّ المُهاجرةَ تُطبّق العقدَ كاملاً.
3. **الحرسُ أوّلُ سطرٍ في المعاملةِ والحفظُ آخرُها** فلا نافذةَ بينهما، والجوابُ يُعاد **حرفاً بحرف** من `response_status`/`response_body` لا مُعاداً بناؤه من حالةٍ تحرّكت بعده — سابقةُ الطور 10 (§«الدَّينُ (د) مسدود») تُتَّبع لا تُعاد كتابتُها.
4. **الحالةُ لا تُقبل من عميلٍ في أيِّ جسم**: `stores.state` إسقاطٌ، فحقلُ حالةٍ في حمولةِ طلبٍ يخرق القاعدةَ 1 في §19.2.
5. **`http/server.ts` يصير القارئَ الثانيَ للبيئة** فتُحدَّث `ENV_READING_FILES` **بالاسم**، و`HTTP_AWARE_FILES` تخرج من الفراغِ بأسماءِ ملفّاتِ الإطارِ وحدَها. ولا يُوسَّع نمطٌ ولا يُبطَل حارس.
6. **وظيفةُ CI `marketplace-db-integration` تُضاف مع 4/6** (لا اليومَ: وظيفةٌ تُضاف ولا تركض وعدٌ ثانٍ بلا حارس)، وحزمةُ التكاملِ تبقى بإعدادها المنفصلِ و`fileParallelism: false` لأنّ الملفّاتَ تتشارك مخطَّطاً واحداً.
7. **فارقُ إصدارِ المحرّك** بين Postgres المُدمَجِ محلّيّاً و`postgres:15` في CI **دَينٌ مُعلَنٌ** يُقاس أوّلَ ركضةٍ على المنصّة.
...
- [SUBSCRIPTION_EVENTS.md — أحداثُ الاشتراكِ وصندوقُ الصادرِ ومكافأةُ الإحالة (Phase 10 · MR 5/6)](../02-architecture/SUBSCRIPTION_EVENTS.md)
- [PHASE10_EXIT_GATE_E2E.md — بوابة خروج المرحلة 10 (Phase 10 · MR 6/6)](../12-testing/PHASE10_EXIT_GATE_E2E.md)
- [ADR-016 — دفترُ قراراتِ السوقِ والظهورُ المُشتَقّ (Phase 11 · MR 1/6)](../15-decisions/ADR-016-marketplace-store-ownership-catalog-and-moderation-boundary.md)
- [MARKETPLACE_CATALOG.md — نموذج مجال أساسِ السوق (Phase 11 · MR 1/6)](../03-domain/MARKETPLACE_CATALOG.md)
- [عقود خدمة السوق — README (Phase 11 · MR 1/6)](../../services/marketplace/contracts/README.md)
- [طبقةُ مجالِ خدمةِ السوق — `services/marketplace/src/domain/` (Phase 11 · MR 2/6)](../../services/marketplace/src/index.ts)
- [استمراريّةُ خدمةِ السوق — مُهاجرةٌ تُطبّق العقدَ حرفاً وإسقاطٌ محروسٌ بالتسلسل (Phase 11 · MR 3/6)](../02-architecture/MARKETPLACE_PERSISTENCE.md)
