...
## 16. Phase 09 (Reputation + Fraud) — قيد التنفيذ 🚧 (2026-08-23) · MR 1/6 من ستّ مدفوعة
...
### 16-د. المراجعة التالية — MR 2/6: طبقة المجال النقيّة
...
**والدَّين المُعلَن الذي يبقى مفتوحاً بعد MR 1/6:** ناشرُ `reputation_outbox` (نفس دَين الأطوار 06 · 07 · 08 — لا مُشغّل دوريّ في المستودع بعد) · مستهلكُ حدثَي الطلب مؤجَّلٌ إلى **MR 5/6** بقرار · ولا تُعلَن المرحلة مكتملة قبل **MR 6/6**: بوابةُ خروجٍ في `packages/reputation-e2e` تُثبت أنّ طلباً مكتملاً عبر HTTP العام يُنتج **حدث سمعةٍ واحداً لا صفراً ولا اثنين**، وأنّ **إعادة الحدث نفسه لا تُضاعف النقاط**، ووثيقتُها `docs/12-testing/PHASE09_EXIT_GATE_E2E.md`.
