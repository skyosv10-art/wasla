...
## 14. Phase 08 (Negotiation & Chat) — قيد التنفيذ 🔄 (بدأت 2026-08-23) · MR 4/6 **مدمجة في `main`** من ستّ
...
6. **وقبل كل شيء: §2-أ** — حصّة دقائق CI منتهية **ولن تُجدَّد**، فأنبوب أيّ مراجعة أحمر لسببٍ تشغيليّ وحده. **الدمج بأنبوب أحمر مأذونٌ فيه بقرار مالك المستودع (2026-08-23)** بشروطه الثلاثة في §2-أ: كلّ رقم مُقاسٌ محلّيّاً ومُسجَّل · وما يحتاج محرّكاً يُشغَّل على Postgres حقيقي محلّيّاً قبل الدمج · ولا يُدمَج ما لم يُشغَّل. **البوابة تُنقَل إلى جهازك لا تُلغى.**
