...
| 01 | Identity Foundation | **In Progress** — عقود + أنواع + مكدّ (ADR-005) + نواة مجردة (MR 1) + طبقة Postgres (MR 2) + طبقة Fastify HTTP (MR 3) + **تكامل CI/DB (MR 4)** (~95%) | إنشاء مستخدم من Telegram وبقاء هويته مستقرة عبر تغيير Username | 01, 09, 10, 11, 12 | (1) ~~اختيار المكدّ~~ حُلّ. (2) ~~النواة المجردة~~ حُلّ ([!11](https://gitlab.com/uxxxu/wasla/-/merge_requests/11)). (3) ~~طبقة Postgres~~ حُلّ ([!12](https://gitlab.com/uxxxu/wasla/-/merge_requests/12)). (4) ~~طبقة Fastify HTTP~~ حُلّ ([!13](https://gitlab.com/uxxxu/wasla/-/merge_requests/13)). (5) ~~تكامل CI/DB~~ حُلّ ([!14](https://gitlab.com/uxxxu/wasla/-/merge_requests/14)). (6) Exit Gate E2E رسمي (MR 5) — معلّق. | 2026-08-20 | **[MR !2](https://gitlab.com/uxxxu/wasla/-/merge_requests/2)** (عقود) + `@wasla/contracts-identity` (13) + [ADR-005](../15-decisions/ADR-005-identity-service-implementation-stack.md) + [MR !11](https://gitlab.com/uxxxu/wasla/-/merge_requests/11) (نواة: 15) + [MR !12](https://gitlab.com/uxxxu/wasla/-/merge_requests/12) (Drizzle/Postgres) + [MR !13](https://gitlab.com/uxxxu/wasla/-/merge_requests/13) (Fastify HTTP: 9) + **[MR !14](https://gitlab.com/uxxxu/wasla/-/merge_requests/14)** (CI `db-integration` job + خدمة postgres). 24 اختباراً + 3 تكامل + E2E محلي. | MR 5 (Exit Gate E2E) |
