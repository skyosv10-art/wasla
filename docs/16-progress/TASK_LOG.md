...
- **Related:** Phase 05 · MR 4/6 · [ADR-012](../15-decisions/ADR-012-driver-core-eligibility-derivation-and-candidacy-publication.md) · [DRIVER_HTTP.md](../04-api/DRIVER_HTTP.md) · [HANDOFF_NEXT_STEPS §13](HANDOFF_NEXT_STEPS.md)
