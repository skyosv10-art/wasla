...
- **Next:** MR 2/6 — طبقة مجال نقيّة `@wasla/drivers-service`: **حاسب الأهليّة أولاً** بجدولٍ صريح لكل شرط وكود عجزه وقاعدة «السبب الأوّل يفوز»، وآلة حالة الوثيقة والمركبة، ومُهيّئات ذاكرة تُحاكي قيود `schema.sql` بأسمائها — بلا قاعدة وبلا HTTP. الخطّة الكاملة للمراجعات الستّ في [HANDOFF_NEXT_STEPS §13](HANDOFF_NEXT_STEPS.md).
