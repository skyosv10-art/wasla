...
| `scripts/checks/validate-authz-policy.sh` البابانِ 7 و8 — ربطُ المُنتَفِعِ والمُستأجِرِ مُثبَتٌ في الشفرةِ لا مُدَّعىً، وعدَّادانِ مُشتَقّانِ يُرفَضُ كتابةُ أيٍّ منهُما بيدٍ، والمساعدونَ يُقرَأونَ **على أيِّ عمقٍ** (31 حالةَ طفرةٍ · كانت 5 ثمَّ 25 · [ADR-028](../15-decisions/ADR-028-token-bound-owner-binding.md)) | Implemented | M1-05B |
