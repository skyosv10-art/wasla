...
| `services/delivery/` | In Progress | M5-13 (المراجعةُ 1/N — عقدُ السيرِ — 2026-09-09) | Phase 13 | **[ADR-026](../15-decisions/ADR-026-store-order-delivery-workflow.md):** الوفاءُ دفترٌ مستقلٌّ عن الطلبِ والمخزونِ والإسنادِ؛ آلةُ حالةٍ مغلقةٌ (10 حالاتٍ) بجدولٍ مكتوبٍ ودالّةٍ نقيّةٍ، والفاعلُ جزءٌ من الجدولِ. عقودٌ (`schema.sql` · `events.json` · `errors.md`) ونواةُ مجالٍ باختباراتِ وحدةٍ **17/17**. **ولا مالَ ولا نصَّ حرٍّ ولا بياناً شخصيّاً في أيِّ حمولةٍ** — الدفعُ حدُّ `M5-17`. **مؤجَّلٌ ومُعلَنٌ:** محوّلاتُ PostgreSQL · HTTP · المستهلكُ و`outbox` · بوّابةُ الخروجِ (`inventory/payment E2E`) · حجزُ المخزونِ. |
