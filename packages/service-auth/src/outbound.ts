 ...
 *
 * [إضافةٌ 2026-09-17 · `ADR-036`] كانَ هنا: «المسارُ يُمرَّر **بلا سلسلةِ استعلامٍ**
 * لأنّ الربطَ لا يشملها (ADR-021 §4)». **وقد انقلبَ الحكمُ**: الربطُ صارَ يشملُ
 * سلسلةَ الاستعلامِ مُرتَّبةً مُعجَميّاً (`wsvc3` · `RISK-0026`)، فيجبُ أن يُمرَّر
 * هنا **هدفُ الطلبِ كما سيُرسَل** — المسارُ مع استعلامِه إن كانَ لهُ استعلامٌ.
 * وتمريرُ المسارِ مقطوعَ الاستعلامِ اليومَ يُنتِج `request_binding_mismatch`
 * عندَ الحدِّ: رفضٌ صريحٌ لا تجاوزٌ صامتٌ.
 */
