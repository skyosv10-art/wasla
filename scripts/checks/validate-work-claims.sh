...
# M0-13: تطبيعُ المالكِ إلى **الجهةِ المسؤولة**.
#
# الشرطُ 6 في WORK_CLAIM_RULE.md يُلزم الوكيلَ الآليَّ بمسؤولٍ بشريٍّ بصيغة
# `@handle (agent:<name>)`. وكان فحصُ التقاطعِ أدناه يقارن عمودَ المالكِ **حرفيّاً**،
...
#
# ما لم يتغيّر: التحقّقُ من صيغةِ المالكِ (أعلاه) يبقى على النصِّ الكاملِ، فالصيغةُ
# ما زالت إلزاميّةً ولا يُقبل مالكٌ بلا `@`. والتطبيعُ **هنا وحدَه** — في مقارنةِ
# الجهتَين — ولا يُوسَّع إلى غيره. ويُثبت الاتّجاهَين في test-governance.sh: أنّ الوكيلَ
# وصاحبَه جهةٌ واحدة، **وأنّ مالكَينِ مختلفَينِ حقّاً ما زال تقاطعُهما مرفوضاً** — لئلّا
# يكون هذا تعطيلاً للفحصِ في ثوبِ تطبيع.
owner_party() {
  local o="$1"
