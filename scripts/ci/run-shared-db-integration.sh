...
# • **لا يقفُ عندَ أوّلِ إخفاقٍ**: يُشغِّلُ السيقانَ كلَّها ثمّ يطبعُ خلاصةً،
...
LEGS=(
  ...
  # M5-12 · ساقُ البحثِ تُذيَّلُ لا تُقحَمُ في الوسطِ: الترتيبُ **هو ترتيبُ مصفوفةِ
...
echo
echo "✓ ${#PASSED[@]} مجموعةً نجحت تِباعاً على قاعدةٍ واحدةٍ."
