/**
 * drizzle-kit config for the Customer Core service.
 *
 * The canonical DDL is `contracts/schema.sql` (ADR-004 · ADR-009); this config
 ...
 *
 * Scripts: pnpm --filter @wasla/customers-service db:generate | db:push | db:studio
 */
...
export default defineConfig({
  ...
  dbCredentials: {
    url:
      ...
      "postgres://wasla:wasla@localhost:5432/wasla_customer",
  },
  strict: true,
  verbose: true,
});
