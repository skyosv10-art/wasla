...
-- pass. `negotiation_outbox` already had both columns; this aligns delivery_outbox.
--
...
ALTER TABLE "delivery_outbox" ADD COLUMN IF NOT EXISTS "attempts" INTEGER NOT NULL DEFAULT 0;--> statement-breakpoint
ALTER TABLE "delivery_outbox" ADD COLUMN IF NOT EXISTS "last_error" TEXT;
