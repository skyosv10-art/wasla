...
ALTER TABLE dispatch_outbox ADD COLUMN IF NOT EXISTS sequence_number BIGINT GENERATED ALWAYS AS IDENTITY;

DROP INDEX IF EXISTS ix_dispatch_outbox_unpublished;
