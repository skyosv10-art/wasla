/**
 * drizzle-kit config for the Driver Core service.
 *
 * The canonical DDL is `contracts/schema.sql` (ADR-011/ADR-012); this config
 ...
 *
 * Scripts: pnpm --filter @wasla/drivers-service db:generate | db:push | db:studio
 */
...
export default defineConfig({
  ...
  dbCredentials: {
    url:
      ...
      "postgres://wasla:wasla@localhost:5432/wasla_drivers",
  },
  strict: true,
  verbose: true,
});
