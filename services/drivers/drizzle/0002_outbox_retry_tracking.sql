...
-- pass. `negotiation_outbox` already had both columns; this aligns driver_outbox.
--
...
ALTER TABLE "driver_outbox" ADD COLUMN IF NOT EXISTS "attempts" INTEGER NOT NULL DEFAULT 0;--> statement-breakpoint
ALTER TABLE "driver_outbox" ADD COLUMN IF NOT EXISTS "last_error" TEXT;
