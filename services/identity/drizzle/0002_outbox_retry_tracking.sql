...
-- pass. `negotiation_outbox` already had both columns; this aligns identity_outbox.
--
...
ALTER TABLE "identity_outbox" ADD COLUMN IF NOT EXISTS "attempts" INTEGER NOT NULL DEFAULT 0;--> statement-breakpoint
ALTER TABLE "identity_outbox" ADD COLUMN IF NOT EXISTS "last_error" TEXT;
