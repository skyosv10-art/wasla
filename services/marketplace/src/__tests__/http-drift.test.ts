...
describe("حارسُ التباعد: المساراتُ المسجَّلةُ والعقد", () => {
  ...
  it("العمليّاتُ إحدى وعشرين بالضبط والمساراتُ سبعةَ عشر — كما تُعلن حزمةُ العقد", () => {
    /**
     * الرقمُ من حزمةِ العقدِ لا مكتوباً هنا: عمليّةٌ تُضاف بلا تحديثِ الثابتِ والوثيقةِ معاً
     * تسقط هنا قبل أن تصل إلى أوّلِ مُتَّصل. والفرقُ بين 21 و17 مقصودٌ: أربعةُ مساراتٍ تحمل
