/**
 * **إعادةُ الإرسالِ تُعيد الجوابَ المحفوظ** — جدولُ منعِ التكرارِ موصولٌ بمساراتِ الكتابةِ العشرِ.
 *
 ...
 *  2. **نفسُ الجسمِ حقلاً بحقل**: `toEqual` على الجسمِ كلِّه لا على حقلٍ منه. وليست المقارنةُ
 *     على البايتاتِ ولا تقدر أن تكون: `response_body JSONB` يُعيد ترتيبَ المفاتيحِ عندَ
 *     الإخراجِ، وقد قاست بوّابةُ الطورِ 11 ذلك على الشبكةِ فصُحِّحت الدعوى هنا وسُجِّلت في
 *     `RISK-0013`. جوابٌ
...
describe.skipIf(!PG_ENABLED)("إعادةُ الإرسالِ فوق Postgres — الجوابُ المحفوظُ حقلاً بحقل", () => {
  let pg: PgFixture;
