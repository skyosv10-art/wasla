/**
 * بصمةُ الطلبِ ومِغلافُ الإعادة — الطريقُ الذي يجعل مفتاحاً مُعاداً يُعيد **الجوابَ المحفوظ**.
 *
 * وكان هذا السطرُ يقول «نفسَ البايتات»، وأسقطت بوّابةُ خروجِ الطورِ 11 الدعوى بقياسٍ على
 * الشبكة: الجسمُ يُحفَظ في `response_body JSONB`، وJSONB شجرةٌ مُفكَّكةٌ **يُعاد ترتيبُ
 * مفاتيحِها** عندَ الإخراج. فالمُنفَّذُ هو **نفسُ الحالةِ ونفسُ الحقولِ في كلّ عمقٍ**، لا
 * نفسُ بايتاتِ النصّ — والفرقُ مُسجَّلٌ في `RISK-0013` بخيارَي برهانِه.
 *
