...
ALTER TABLE "negotiation_outbox" ADD COLUMN "sequence_number" bigint GENERATED ALWAYS AS IDENTITY;--> statement-breakpoint
DROP INDEX IF EXISTS "ix_negotiation_outbox_unpublished";--> statement-breakpoint
CREATE INDEX "ix_negotiation_outbox_unpublished" ON "negotiation_outbox" USING btree ("sequence_number") WHERE "published_at" IS NULL;
