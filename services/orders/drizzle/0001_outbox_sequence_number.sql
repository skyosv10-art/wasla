...
ALTER TABLE "order_outbox" ADD COLUMN "sequence_number" bigint GENERATED ALWAYS AS IDENTITY;--> statement-breakpoint
DROP INDEX IF EXISTS "ix_order_outbox_unpublished";--> statement-breakpoint
CREATE INDEX "ix_order_outbox_unpublished" ON "order_outbox" USING btree ("sequence_number") WHERE "published_at" IS NULL;
