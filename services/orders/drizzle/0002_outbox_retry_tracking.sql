...
-- pass. Wave 1 (`CLM-0245`) aligned five tables; this aligns order_outbox.
--
...
ALTER TABLE "order_outbox" ADD COLUMN IF NOT EXISTS "attempts" INTEGER NOT NULL DEFAULT 0;--> statement-breakpoint
ALTER TABLE "order_outbox" ADD COLUMN IF NOT EXISTS "last_error" TEXT;
