...
-- pass. Wave 1 (`CLM-0245`) aligned five tables; this aligns search_outbox.
--
...
ALTER TABLE "search_outbox" ADD COLUMN IF NOT EXISTS "attempts" INTEGER NOT NULL DEFAULT 0;--> statement-breakpoint
ALTER TABLE "search_outbox" ADD COLUMN IF NOT EXISTS "last_error" TEXT;
